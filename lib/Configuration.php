...
namespace BeLenka\SAP\BusinessPartner;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://:/sap/opu/odata/sap/API_BUSINESS_PARTNER';
    ...
    {
        $report  = 'PHP SDK (BeLenka\SAP\BusinessPartner) Debug Report:' . PHP_EOL;
