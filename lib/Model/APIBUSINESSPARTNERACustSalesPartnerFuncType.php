...
/**
 * APIBUSINESSPARTNERACustSalesPartnerFuncType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustSalesPartnerFuncType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustSalesPartnerFuncType';
    ...
    */
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrganization($sales_organization)
    {
        ...
        if ((mb_strlen($sales_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_organization when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 4.');
        }
    ...
    public function setDistributionChannel($distribution_channel)
    {
        ...
        if ((mb_strlen($distribution_channel) > 2)) {
            throw new \InvalidArgumentException('invalid length for $distribution_channel when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 2.');
        }
    ...
    public function setDivision($division)
    {
        ...
        if ((mb_strlen($division) > 2)) {
            throw new \InvalidArgumentException('invalid length for $division when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 2.');
        }
    ...
    public function setPartnerCounter($partner_counter)
    {
        ...
        if ((mb_strlen($partner_counter) > 3)) {
            throw new \InvalidArgumentException('invalid length for $partner_counter when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 3.');
        }
    ...
    public function setPartnerFunction($partner_function)
    {
        ...
        if ((mb_strlen($partner_function) > 2)) {
            throw new \InvalidArgumentException('invalid length for $partner_function when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 2.');
        }
    ...
    public function setBpCustomerNumber($bp_customer_number)
    {
        ...
        if (!is_null($bp_customer_number) && (mb_strlen($bp_customer_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $bp_customer_number when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 10.');
        }
    ...
    public function setCustomerPartnerDescription($customer_partner_description)
    {
        ...
        if (!is_null($customer_partner_description) && (mb_strlen($customer_partner_description) > 30)) {
            throw new \InvalidArgumentException('invalid length for $customer_partner_description when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 30.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if (!is_null($supplier) && (mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 10.');
        }
    ...
    public function setPersonnelNumber($personnel_number)
    {
        ...
        if (!is_null($personnel_number) && (mb_strlen($personnel_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $personnel_number when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 8.');
        }
    ...
    public function setContactPerson($contact_person)
    {
        ...
        if (!is_null($contact_person) && (mb_strlen($contact_person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $contact_person when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if (!is_null($address_id) && (mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 10.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERACustSalesPartnerFuncType., must be smaller than or equal to 4.');
        }
