...
/**
 * APIBUSINESSPARTNERABPCreditWorthinessTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABPCreditWorthinessTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BPCreditWorthinessType-create';
    ...
    */
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABPCreditWorthinessTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setBusPartCreditStanding($bus_part_credit_standing)
    {
        ...
        if (!is_null($bus_part_credit_standing) && (mb_strlen($bus_part_credit_standing) > 1)) {
            throw new \InvalidArgumentException('invalid length for $bus_part_credit_standing when calling APIBUSINESSPARTNERABPCreditWorthinessTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setBpCreditStandingStatus($bp_credit_standing_status)
    {
        ...
        if (!is_null($bp_credit_standing_status) && (mb_strlen($bp_credit_standing_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $bp_credit_standing_status when calling APIBUSINESSPARTNERABPCreditWorthinessTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setBpLegalProceedingStatus($bp_legal_proceeding_status)
    {
        ...
        if (!is_null($bp_legal_proceeding_status) && (mb_strlen($bp_legal_proceeding_status) > 2)) {
            throw new \InvalidArgumentException('invalid length for $bp_legal_proceeding_status when calling APIBUSINESSPARTNERABPCreditWorthinessTypeCreate., must be smaller than or equal to 2.');
        }
