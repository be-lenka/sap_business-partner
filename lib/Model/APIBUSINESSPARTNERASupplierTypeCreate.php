...
/**
 * APIBUSINESSPARTNERASupplierTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERASupplierTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_SupplierType-create';
    ...
    protected static $openAPITypes = [
        ...
        'to_supplier_company' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreateToSupplierCompany',
        'to_supplier_purchasing_org' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreateToSupplierPurchasingOrg',
        'to_supplier_text' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreateToSupplierText'
    ];
    ...
    */
    ...
    public function setSupplier($supplier)
    {
        ...
        if ((mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAlternativePayeeAccountNumber($alternative_payee_account_number)
    {
        ...
        if (!is_null($alternative_payee_account_number) && (mb_strlen($alternative_payee_account_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $alternative_payee_account_number when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBusinessPartnerPanNumber($business_partner_pan_number)
    {
        ...
        if (!is_null($business_partner_pan_number) && (mb_strlen($business_partner_pan_number) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_pan_number when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if (!is_null($customer) && (mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplierAccountGroup($supplier_account_group)
    {
        ...
        if (!is_null($supplier_account_group) && (mb_strlen($supplier_account_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $supplier_account_group when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setFiscalAddress($fiscal_address)
    {
        ...
        if (!is_null($fiscal_address) && (mb_strlen($fiscal_address) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fiscal_address when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setPaymentReason($payment_reason)
    {
        ...
        if (!is_null($payment_reason) && (mb_strlen($payment_reason) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_reason when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setResponsibleType($responsible_type)
    {
        ...
        if (!is_null($responsible_type) && (mb_strlen($responsible_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $responsible_type when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setSuplrQualityManagementSystem($suplr_quality_management_system)
    {
        ...
        if (!is_null($suplr_quality_management_system) && (mb_strlen($suplr_quality_management_system) > 4)) {
            throw new \InvalidArgumentException('invalid length for $suplr_quality_management_system when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setSupplierCorporateGroup($supplier_corporate_group)
    {
        ...
        if (!is_null($supplier_corporate_group) && (mb_strlen($supplier_corporate_group) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier_corporate_group when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplierProcurementBlock($supplier_procurement_block)
    {
        ...
        if (!is_null($supplier_procurement_block) && (mb_strlen($supplier_procurement_block) > 2)) {
            throw new \InvalidArgumentException('invalid length for $supplier_procurement_block when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setTaxNumberResponsible($tax_number_responsible)
    {
        ...
        if (!is_null($tax_number_responsible) && (mb_strlen($tax_number_responsible) > 18)) {
            throw new \InvalidArgumentException('invalid length for $tax_number_responsible when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 18.');
        }
    ...
    public function setTaxNumberType($tax_number_type)
    {
        ...
        if (!is_null($tax_number_type) && (mb_strlen($tax_number_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $tax_number_type when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setSuplrProofOfDelivRlvtCode($suplr_proof_of_deliv_rlvt_code)
    {
        ...
        if (!is_null($suplr_proof_of_deliv_rlvt_code) && (mb_strlen($suplr_proof_of_deliv_rlvt_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $suplr_proof_of_deliv_rlvt_code when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setDataExchangeInstructionKey($data_exchange_instruction_key)
    {
        ...
        if (!is_null($data_exchange_instruction_key) && (mb_strlen($data_exchange_instruction_key) > 2)) {
            throw new \InvalidArgumentException('invalid length for $data_exchange_instruction_key when calling APIBUSINESSPARTNERASupplierTypeCreate., must be smaller than or equal to 2.');
        }
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreateToSupplierCompany|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreateToSupplierCompany|null $to_supplier_company to_supplier_company
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreateToSupplierPurchasingOrg|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreateToSupplierPurchasingOrg|null $to_supplier_purchasing_org to_supplier_purchasing_org
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreateToSupplierText|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreateToSupplierText|null $to_supplier_text to_supplier_text
     *
     * @return self
     */
