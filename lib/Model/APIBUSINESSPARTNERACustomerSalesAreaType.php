...
/**
 * APIBUSINESSPARTNERACustomerSalesAreaType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustomerSalesAreaType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustomerSalesAreaType';
    ...
    protected static $openAPITypes = [
        ...
        'to_partner_function' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToPartnerFunction',
        'to_sales_area_tax' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToSalesAreaTax',
        'to_sales_area_text' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToSalesAreaText',
        'to_sls_area_addr_depdnt_info' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToSlsAreaAddrDepdntInfo'
    ];
    ...
    */
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrganization($sales_organization)
    {
        ...
        if ((mb_strlen($sales_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_organization when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
    ...
    public function setDistributionChannel($distribution_channel)
    {
        ...
        if ((mb_strlen($distribution_channel) > 2)) {
            throw new \InvalidArgumentException('invalid length for $distribution_channel when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setDivision($division)
    {
        ...
        if ((mb_strlen($division) > 2)) {
            throw new \InvalidArgumentException('invalid length for $division when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setAccountByCustomer($account_by_customer)
    {
        ...
        if (!is_null($account_by_customer) && (mb_strlen($account_by_customer) > 12)) {
            throw new \InvalidArgumentException('invalid length for $account_by_customer when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 12.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
    ...
    public function setBillingIsBlockedForCustomer($billing_is_blocked_for_customer)
    {
        ...
        if (!is_null($billing_is_blocked_for_customer) && (mb_strlen($billing_is_blocked_for_customer) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_is_blocked_for_customer when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setCreditControlArea($credit_control_area)
    {
        ...
        if (!is_null($credit_control_area) && (mb_strlen($credit_control_area) > 4)) {
            throw new \InvalidArgumentException('invalid length for $credit_control_area when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 5.');
        }
    ...
    public function setCustomerAbcClassification($customer_abc_classification)
    {
        ...
        if (!is_null($customer_abc_classification) && (mb_strlen($customer_abc_classification) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_abc_classification when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomerAccountAssignmentGroup($customer_account_assignment_group)
    {
        ...
        if (!is_null($customer_account_assignment_group) && (mb_strlen($customer_account_assignment_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_account_assignment_group when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomerGroup($customer_group)
    {
        ...
        if (!is_null($customer_group) && (mb_strlen($customer_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_group when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomerPaymentTerms($customer_payment_terms)
    {
        ...
        if (!is_null($customer_payment_terms) && (mb_strlen($customer_payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_payment_terms when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
    ...
    public function setCustomerPriceGroup($customer_price_group)
    {
        ...
        if (!is_null($customer_price_group) && (mb_strlen($customer_price_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_price_group when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomerPricingProcedure($customer_pricing_procedure)
    {
        ...
        if (!is_null($customer_pricing_procedure) && (mb_strlen($customer_pricing_procedure) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_pricing_procedure when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setCustProdProposalProcedure($cust_prod_proposal_procedure)
    {
        ...
        if (!is_null($cust_prod_proposal_procedure) && (mb_strlen($cust_prod_proposal_procedure) > 2)) {
            throw new \InvalidArgumentException('invalid length for $cust_prod_proposal_procedure when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryIsBlockedForCustomer($delivery_is_blocked_for_customer)
    {
        ...
        if (!is_null($delivery_is_blocked_for_customer) && (mb_strlen($delivery_is_blocked_for_customer) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_is_blocked_for_customer when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryPriority($delivery_priority)
    {
        ...
        if (!is_null($delivery_priority) && (mb_strlen($delivery_priority) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_priority when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsVersion($incoterms_version)
    {
        ...
        if (!is_null($incoterms_version) && (mb_strlen($incoterms_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_version when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 28.');
        }
    ...
    public function setInvoiceDate($invoice_date)
    {
        ...
        if (!is_null($invoice_date) && (mb_strlen($invoice_date) > 2)) {
            throw new \InvalidArgumentException('invalid length for $invoice_date when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setItemOrderProbabilityInPercent($item_order_probability_in_percent)
    {
        ...
        if (!is_null($item_order_probability_in_percent) && (mb_strlen($item_order_probability_in_percent) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_order_probability_in_percent when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 3.');
        }
    ...
    public function setOrderIsBlockedForCustomer($order_is_blocked_for_customer)
    {
        ...
        if (!is_null($order_is_blocked_for_customer) && (mb_strlen($order_is_blocked_for_customer) > 2)) {
            throw new \InvalidArgumentException('invalid length for $order_is_blocked_for_customer when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setPartialDeliveryIsAllowed($partial_delivery_is_allowed)
    {
        ...
        if (!is_null($partial_delivery_is_allowed) && (mb_strlen($partial_delivery_is_allowed) > 1)) {
            throw new \InvalidArgumentException('invalid length for $partial_delivery_is_allowed when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 1.');
        }
    ...
    public function setPriceListType($price_list_type)
    {
        ...
        if (!is_null($price_list_type) && (mb_strlen($price_list_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $price_list_type when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setProductUnitGroup($product_unit_group)
    {
        ...
        if (!is_null($product_unit_group) && (mb_strlen($product_unit_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $product_unit_group when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesGroup($sales_group)
    {
        ...
        if (!is_null($sales_group) && (mb_strlen($sales_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sales_group when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 3.');
        }
    ...
    public function setSalesItemProposal($sales_item_proposal)
    {
        ...
        if (!is_null($sales_item_proposal) && (mb_strlen($sales_item_proposal) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_item_proposal when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOffice($sales_office)
    {
        ...
        if (!is_null($sales_office) && (mb_strlen($sales_office) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_office when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingCondition($shipping_condition)
    {
        ...
        if (!is_null($shipping_condition) && (mb_strlen($shipping_condition) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_condition when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setSupplyingPlant($supplying_plant)
    {
        ...
        if (!is_null($supplying_plant) && (mb_strlen($supplying_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $supplying_plant when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesDistrict($sales_district)
    {
        ...
        if (!is_null($sales_district) && (mb_strlen($sales_district) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_district when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 6.');
        }
    ...
    public function setInvoiceListSchedule($invoice_list_schedule)
    {
        ...
        if (!is_null($invoice_list_schedule) && (mb_strlen($invoice_list_schedule) > 2)) {
            throw new \InvalidArgumentException('invalid length for $invoice_list_schedule when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 2.');
        }
    ...
    public function setExchangeRateType($exchange_rate_type)
    {
        ...
        if (!is_null($exchange_rate_type) && (mb_strlen($exchange_rate_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $exchange_rate_type when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
    ...
    public function setAdditionalCustomerGroup1($additional_customer_group1)
    {
        ...
        if (!is_null($additional_customer_group1) && (mb_strlen($additional_customer_group1) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_customer_group1 when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalCustomerGroup2($additional_customer_group2)
    {
        ...
        if (!is_null($additional_customer_group2) && (mb_strlen($additional_customer_group2) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_customer_group2 when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalCustomerGroup3($additional_customer_group3)
    {
        ...
        if (!is_null($additional_customer_group3) && (mb_strlen($additional_customer_group3) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_customer_group3 when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalCustomerGroup4($additional_customer_group4)
    {
        ...
        if (!is_null($additional_customer_group4) && (mb_strlen($additional_customer_group4) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_customer_group4 when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalCustomerGroup5($additional_customer_group5)
    {
        ...
        if (!is_null($additional_customer_group5) && (mb_strlen($additional_customer_group5) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_customer_group5 when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 3.');
        }
    ...
    public function setPaymentGuaranteeProcedure($payment_guarantee_procedure)
    {
        ...
        if (!is_null($payment_guarantee_procedure) && (mb_strlen($payment_guarantee_procedure) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_guarantee_procedure when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
    ...
    public function setCustomerAccountGroup($customer_account_group)
    {
        ...
        if (!is_null($customer_account_group) && (mb_strlen($customer_account_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_account_group when calling APIBUSINESSPARTNERACustomerSalesAreaType., must be smaller than or equal to 4.');
        }
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToPartnerFunction|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToPartnerFunction|null $to_partner_function to_partner_function
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToSalesAreaTax|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToSalesAreaTax|null $to_sales_area_tax to_sales_area_tax
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToSalesAreaText|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToSalesAreaText|null $to_sales_area_text to_sales_area_text
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToSlsAreaAddrDepdntInfo|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerSalesAreaTypeToSlsAreaAddrDepdntInfo|null $to_sls_area_addr_depdnt_info to_sls_area_addr_depdnt_info
     *
     * @return self
     */
