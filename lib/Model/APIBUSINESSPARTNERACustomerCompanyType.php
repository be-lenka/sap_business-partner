...
/**
 * APIBUSINESSPARTNERACustomerCompanyType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustomerCompanyType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustomerCompanyType';
    ...
    protected static $openAPITypes = [
        ...
        'to_company_text' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerCompanyTypeToCompanyText',
        'to_customer_dunning' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerCompanyTypeToCustomerDunning',
        'to_with_holding_tax' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerCompanyTypeToWithHoldingTax'
    ];
    ...
    */
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setCompanyCode($company_code)
    {
        ...
        if ((mb_strlen($company_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 4.');
        }
    ...
    public function setAparToleranceGroup($apar_tolerance_group)
    {
        ...
        if (!is_null($apar_tolerance_group) && (mb_strlen($apar_tolerance_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $apar_tolerance_group when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 4.');
        }
    ...
    public function setAccountByCustomer($account_by_customer)
    {
        ...
        if (!is_null($account_by_customer) && (mb_strlen($account_by_customer) > 12)) {
            throw new \InvalidArgumentException('invalid length for $account_by_customer when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 12.');
        }
    ...
    public function setAccountingClerk($accounting_clerk)
    {
        ...
        if (!is_null($accounting_clerk) && (mb_strlen($accounting_clerk) > 2)) {
            throw new \InvalidArgumentException('invalid length for $accounting_clerk when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 2.');
        }
    ...
    public function setAccountingClerkFaxNumber($accounting_clerk_fax_number)
    {
        ...
        if (!is_null($accounting_clerk_fax_number) && (mb_strlen($accounting_clerk_fax_number) > 31)) {
            throw new \InvalidArgumentException('invalid length for $accounting_clerk_fax_number when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 31.');
        }
    ...
    public function setAccountingClerkInternetAddress($accounting_clerk_internet_address)
    {
        ...
        if (!is_null($accounting_clerk_internet_address) && (mb_strlen($accounting_clerk_internet_address) > 130)) {
            throw new \InvalidArgumentException('invalid length for $accounting_clerk_internet_address when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 130.');
        }
    ...
    public function setAccountingClerkPhoneNumber($accounting_clerk_phone_number)
    {
        ...
        if (!is_null($accounting_clerk_phone_number) && (mb_strlen($accounting_clerk_phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $accounting_clerk_phone_number when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 30.');
        }
    ...
    public function setAlternativePayerAccount($alternative_payer_account)
    {
        ...
        if (!is_null($alternative_payer_account) && (mb_strlen($alternative_payer_account) > 10)) {
            throw new \InvalidArgumentException('invalid length for $alternative_payer_account when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 4.');
        }
    ...
    public function setCollectiveInvoiceVariant($collective_invoice_variant)
    {
        ...
        if (!is_null($collective_invoice_variant) && (mb_strlen($collective_invoice_variant) > 1)) {
            throw new \InvalidArgumentException('invalid length for $collective_invoice_variant when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerAccountNote($customer_account_note)
    {
        ...
        if (!is_null($customer_account_note) && (mb_strlen($customer_account_note) > 30)) {
            throw new \InvalidArgumentException('invalid length for $customer_account_note when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 30.');
        }
    ...
    public function setCustomerHeadOffice($customer_head_office)
    {
        ...
        if (!is_null($customer_head_office) && (mb_strlen($customer_head_office) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_head_office when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setHouseBank($house_bank)
    {
        ...
        if (!is_null($house_bank) && (mb_strlen($house_bank) > 5)) {
            throw new \InvalidArgumentException('invalid length for $house_bank when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 5.');
        }
    ...
    public function setInterestCalculationCode($interest_calculation_code)
    {
        ...
        if (!is_null($interest_calculation_code) && (mb_strlen($interest_calculation_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $interest_calculation_code when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 2.');
        }
    ...
    public function setIntrstCalcFrequencyInMonths($intrst_calc_frequency_in_months)
    {
        ...
        if (!is_null($intrst_calc_frequency_in_months) && (mb_strlen($intrst_calc_frequency_in_months) > 2)) {
            throw new \InvalidArgumentException('invalid length for $intrst_calc_frequency_in_months when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 2.');
        }
    ...
    public function setLayoutSortingRule($layout_sorting_rule)
    {
        ...
        if (!is_null($layout_sorting_rule) && (mb_strlen($layout_sorting_rule) > 3)) {
            throw new \InvalidArgumentException('invalid length for $layout_sorting_rule when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 3.');
        }
    ...
    public function setPaymentBlockingReason($payment_blocking_reason)
    {
        ...
        if (!is_null($payment_blocking_reason) && (mb_strlen($payment_blocking_reason) > 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_blocking_reason when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 1.');
        }
    ...
    public function setPaymentMethodsList($payment_methods_list)
    {
        ...
        if (!is_null($payment_methods_list) && (mb_strlen($payment_methods_list) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_methods_list when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setPaymentReason($payment_reason)
    {
        ...
        if (!is_null($payment_reason) && (mb_strlen($payment_reason) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_reason when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentTerms($payment_terms)
    {
        ...
        if (!is_null($payment_terms) && (mb_strlen($payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_terms when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 4.');
        }
    ...
    public function setReconciliationAccount($reconciliation_account)
    {
        ...
        if (!is_null($reconciliation_account) && (mb_strlen($reconciliation_account) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reconciliation_account when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setUserAtCustomer($user_at_customer)
    {
        ...
        if (!is_null($user_at_customer) && (mb_strlen($user_at_customer) > 15)) {
            throw new \InvalidArgumentException('invalid length for $user_at_customer when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 15.');
        }
    ...
    public function setCashPlanningGroup($cash_planning_group)
    {
        ...
        if (!is_null($cash_planning_group) && (mb_strlen($cash_planning_group) > 10)) {
            throw new \InvalidArgumentException('invalid length for $cash_planning_group when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setKnownOrNegotiatedLeave($known_or_negotiated_leave)
    {
        ...
        if (!is_null($known_or_negotiated_leave) && (mb_strlen($known_or_negotiated_leave) > 4)) {
            throw new \InvalidArgumentException('invalid length for $known_or_negotiated_leave when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 4.');
        }
    ...
    public function setValueAdjustmentKey($value_adjustment_key)
    {
        ...
        if (!is_null($value_adjustment_key) && (mb_strlen($value_adjustment_key) > 2)) {
            throw new \InvalidArgumentException('invalid length for $value_adjustment_key when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomerAccountGroup($customer_account_group)
    {
        ...
        if (!is_null($customer_account_group) && (mb_strlen($customer_account_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_account_group when calling APIBUSINESSPARTNERACustomerCompanyType., must be smaller than or equal to 4.');
        }
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerCompanyTypeToCompanyText|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerCompanyTypeToCompanyText|null $to_company_text to_company_text
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerCompanyTypeToCustomerDunning|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerCompanyTypeToCustomerDunning|null $to_customer_dunning to_customer_dunning
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerCompanyTypeToWithHoldingTax|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerCompanyTypeToWithHoldingTax|null $to_with_holding_tax to_with_holding_tax
     *
     * @return self
     */
