...
/**
 * APIBUSINESSPARTNERACustomerWithHoldingTaxTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustomerWithHoldingTaxTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustomerWithHoldingTaxType-create';
    ...
    */
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setCompanyCode($company_code)
    {
        ...
        if ((mb_strlen($company_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setWithholdingTaxType($withholding_tax_type)
    {
        ...
        if ((mb_strlen($withholding_tax_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_type when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setWithholdingTaxCode($withholding_tax_code)
    {
        ...
        if (!is_null($withholding_tax_code) && (mb_strlen($withholding_tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_code when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setWithholdingTaxNumber($withholding_tax_number)
    {
        ...
        if (!is_null($withholding_tax_number) && (mb_strlen($withholding_tax_number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_number when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeCreate., must be smaller than or equal to 16.');
        }
    ...
    public function setWithholdingTaxCertificate($withholding_tax_certificate)
    {
        ...
        if (!is_null($withholding_tax_certificate) && (mb_strlen($withholding_tax_certificate) > 25)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_certificate when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeCreate., must be smaller than or equal to 25.');
        }
    ...
    public function setExemptionReason($exemption_reason)
    {
        ...
        if (!is_null($exemption_reason) && (mb_strlen($exemption_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $exemption_reason when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeCreate., must be smaller than or equal to 4.');
        }
