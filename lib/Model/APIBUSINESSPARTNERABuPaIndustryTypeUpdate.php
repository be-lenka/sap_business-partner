...
/**
 * APIBUSINESSPARTNERABuPaIndustryTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABuPaIndustryTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BuPaIndustryType-update';
    ...
    */
    ...
    public function setIsStandardIndustry($is_standard_industry)
    {
        ...
        if (!is_null($is_standard_industry) && (mb_strlen($is_standard_industry) > 1)) {
            throw new \InvalidArgumentException('invalid length for $is_standard_industry when calling APIBUSINESSPARTNERABuPaIndustryTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setIndustryKeyDescription($industry_key_description)
    {
        ...
        if (!is_null($industry_key_description) && (mb_strlen($industry_key_description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $industry_key_description when calling APIBUSINESSPARTNERABuPaIndustryTypeUpdate., must be smaller than or equal to 100.');
        }
