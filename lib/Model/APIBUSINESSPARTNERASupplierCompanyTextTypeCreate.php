...
/**
 * APIBUSINESSPARTNERASupplierCompanyTextTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERASupplierCompanyTextTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_SupplierCompanyTextType-create';
    ...
    */
    ...
    public function setSupplier($supplier)
    {
        ...
        if ((mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APIBUSINESSPARTNERASupplierCompanyTextTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setCompanyCode($company_code)
    {
        ...
        if ((mb_strlen($company_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling APIBUSINESSPARTNERASupplierCompanyTextTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling APIBUSINESSPARTNERASupplierCompanyTextTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setLongTextId($long_text_id)
    {
        ...
        if ((mb_strlen($long_text_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $long_text_id when calling APIBUSINESSPARTNERASupplierCompanyTextTypeCreate., must be smaller than or equal to 4.');
        }
