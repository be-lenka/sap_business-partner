...
/**
 * APIBUSINESSPARTNERACustomerUnloadingPointType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustomerUnloadingPointType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustomerUnloadingPointType';
    ...
    */
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIBUSINESSPARTNERACustomerUnloadingPointType., must be smaller than or equal to 10.');
        }
    ...
    public function setUnloadingPointName($unloading_point_name)
    {
        ...
        if ((mb_strlen($unloading_point_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $unloading_point_name when calling APIBUSINESSPARTNERACustomerUnloadingPointType., must be smaller than or equal to 25.');
        }
    ...
    public function setCustomerFactoryCalenderCode($customer_factory_calender_code)
    {
        ...
        if (!is_null($customer_factory_calender_code) && (mb_strlen($customer_factory_calender_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_factory_calender_code when calling APIBUSINESSPARTNERACustomerUnloadingPointType., must be smaller than or equal to 2.');
        }
    ...
    public function setBpGoodsReceivingHoursCode($bp_goods_receiving_hours_code)
    {
        ...
        if (!is_null($bp_goods_receiving_hours_code) && (mb_strlen($bp_goods_receiving_hours_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $bp_goods_receiving_hours_code when calling APIBUSINESSPARTNERACustomerUnloadingPointType., must be smaller than or equal to 3.');
        }
