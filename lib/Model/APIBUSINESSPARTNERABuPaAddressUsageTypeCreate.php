...
/**
 * APIBUSINESSPARTNERABuPaAddressUsageTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABuPaAddressUsageTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BuPaAddressUsageType-create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['address_usage'] === null) {
            $invalidProperties[] = "'address_usage' can't be null";
        }
        if ((mb_strlen($this->container['address_usage']) > 10)) {
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABuPaAddressUsageTypeCreate., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string $validity_end_date Validity End of a Business Partner Address Usage
     *
     * @return self
     */
     ...
     * Sets address_usage
     *
     * @param string $address_usage address_usage
     *
     * @return self
     */
    public function setAddressUsage($address_usage)
    {
        ...
        if ((mb_strlen($address_usage) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_usage when calling APIBUSINESSPARTNERABuPaAddressUsageTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if ((mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APIBUSINESSPARTNERABuPaAddressUsageTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERABuPaAddressUsageTypeCreate., must be smaller than or equal to 4.');
        }
