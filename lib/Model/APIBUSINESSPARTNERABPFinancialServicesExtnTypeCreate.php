...
/**
 * APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BPFinancialServicesExtnType-create';
    ...
    */
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setTradingPartner($trading_partner)
    {
        ...
        if (!is_null($trading_partner) && (mb_strlen($trading_partner) > 6)) {
            throw new \InvalidArgumentException('invalid length for $trading_partner when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setFactoryCalendar($factory_calendar)
    {
        ...
        if (!is_null($factory_calendar) && (mb_strlen($factory_calendar) > 2)) {
            throw new \InvalidArgumentException('invalid length for $factory_calendar when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setBusinessPartnerOfficeCountry($business_partner_office_country)
    {
        ...
        if (!is_null($business_partner_office_country) && (mb_strlen($business_partner_office_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_office_country when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setBusinessPartnerOfficeRegion($business_partner_office_region)
    {
        ...
        if (!is_null($business_partner_office_region) && (mb_strlen($business_partner_office_region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_office_region when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setBpRegisteredOfficeName($bp_registered_office_name)
    {
        ...
        if (!is_null($bp_registered_office_name) && (mb_strlen($bp_registered_office_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $bp_registered_office_name when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 35.');
        }
    ...
    public function setBpBalanceSheetCurrency($bp_balance_sheet_currency)
    {
        ...
        if (!is_null($bp_balance_sheet_currency) && (mb_strlen($bp_balance_sheet_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $bp_balance_sheet_currency when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setBpLastCapitalIncreaseYear($bp_last_capital_increase_year)
    {
        ...
        if (!is_null($bp_last_capital_increase_year) && (mb_strlen($bp_last_capital_increase_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $bp_last_capital_increase_year when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBpBalanceSheetDisplayType($bp_balance_sheet_display_type)
    {
        ...
        if (!is_null($bp_balance_sheet_display_type) && (mb_strlen($bp_balance_sheet_display_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $bp_balance_sheet_display_type when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setBusinessPartnerCitizenship($business_partner_citizenship)
    {
        ...
        if (!is_null($business_partner_citizenship) && (mb_strlen($business_partner_citizenship) > 3)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_citizenship when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setBpMaritalPropertyRegime($bp_marital_property_regime)
    {
        ...
        if (!is_null($bp_marital_property_regime) && (mb_strlen($bp_marital_property_regime) > 2)) {
            throw new \InvalidArgumentException('invalid length for $bp_marital_property_regime when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setBusinessPartnerIncomeCurrency($business_partner_income_currency)
    {
        ...
        if (!is_null($business_partner_income_currency) && (mb_strlen($business_partner_income_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_income_currency when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setBpAnnualNetIncomeYear($bp_annual_net_income_year)
    {
        ...
        if (!is_null($bp_annual_net_income_year) && (mb_strlen($bp_annual_net_income_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $bp_annual_net_income_year when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBpMonthlyNetIncomeMonth($bp_monthly_net_income_month)
    {
        ...
        if (!is_null($bp_monthly_net_income_month) && (mb_strlen($bp_monthly_net_income_month) > 2)) {
            throw new \InvalidArgumentException('invalid length for $bp_monthly_net_income_month when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setBpMonthlyNetIncomeYear($bp_monthly_net_income_year)
    {
        ...
        if (!is_null($bp_monthly_net_income_year) && (mb_strlen($bp_monthly_net_income_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $bp_monthly_net_income_year when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBpPlaceOfDeathName($bp_place_of_death_name)
    {
        ...
        if (!is_null($bp_place_of_death_name) && (mb_strlen($bp_place_of_death_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $bp_place_of_death_name when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setUndesirabilityReason($undesirability_reason)
    {
        ...
        if (!is_null($undesirability_reason) && (mb_strlen($undesirability_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $undesirability_reason when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setUndesirabilityComment($undesirability_comment)
    {
        ...
        if (!is_null($undesirability_comment) && (mb_strlen($undesirability_comment) > 35)) {
            throw new \InvalidArgumentException('invalid length for $undesirability_comment when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 35.');
        }
    ...
    public function setBpGroupingCharacter($bp_grouping_character)
    {
        ...
        if (!is_null($bp_grouping_character) && (mb_strlen($bp_grouping_character) > 10)) {
            throw new \InvalidArgumentException('invalid length for $bp_grouping_character when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setBpLetterSalutation($bp_letter_salutation)
    {
        ...
        if (!is_null($bp_letter_salutation) && (mb_strlen($bp_letter_salutation) > 2)) {
            throw new \InvalidArgumentException('invalid length for $bp_letter_salutation when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setBusinessPartnerTargetGroup($business_partner_target_group)
    {
        ...
        if (!is_null($business_partner_target_group) && (mb_strlen($business_partner_target_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_target_group when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBusinessPartnerEmployeeGroup($business_partner_employee_group)
    {
        ...
        if (!is_null($business_partner_employee_group) && (mb_strlen($business_partner_employee_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_employee_group when calling APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate., must be smaller than or equal to 4.');
        }
