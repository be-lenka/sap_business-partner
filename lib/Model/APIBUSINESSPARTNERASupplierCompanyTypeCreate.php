...
/**
 * APIBUSINESSPARTNERASupplierCompanyTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERASupplierCompanyTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_SupplierCompanyType-create';
    ...
    protected static $openAPITypes = [
        ...
        'to_company_text' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeCreateToCompanyText',
        'to_supplier' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreate',
        'to_supplier_dunning' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeCreateToSupplierDunning',
        'to_supplier_with_holding_tax' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeCreateToSupplierWithHoldingTax'
    ];
    ...
    */
    ...
    public function setSupplier($supplier)
    {
        ...
        if ((mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setCompanyCode($company_code)
    {
        ...
        if ((mb_strlen($company_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentBlockingReason($payment_blocking_reason)
    {
        ...
        if (!is_null($payment_blocking_reason) && (mb_strlen($payment_blocking_reason) > 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_blocking_reason when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setAccountingClerk($accounting_clerk)
    {
        ...
        if (!is_null($accounting_clerk) && (mb_strlen($accounting_clerk) > 2)) {
            throw new \InvalidArgumentException('invalid length for $accounting_clerk when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setAccountingClerkFaxNumber($accounting_clerk_fax_number)
    {
        ...
        if (!is_null($accounting_clerk_fax_number) && (mb_strlen($accounting_clerk_fax_number) > 31)) {
            throw new \InvalidArgumentException('invalid length for $accounting_clerk_fax_number when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 31.');
        }
    ...
    public function setAccountingClerkPhoneNumber($accounting_clerk_phone_number)
    {
        ...
        if (!is_null($accounting_clerk_phone_number) && (mb_strlen($accounting_clerk_phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $accounting_clerk_phone_number when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 30.');
        }
    ...
    public function setSupplierClerk($supplier_clerk)
    {
        ...
        if (!is_null($supplier_clerk) && (mb_strlen($supplier_clerk) > 15)) {
            throw new \InvalidArgumentException('invalid length for $supplier_clerk when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 15.');
        }
    ...
    public function setSupplierClerkUrl($supplier_clerk_url)
    {
        ...
        if (!is_null($supplier_clerk_url) && (mb_strlen($supplier_clerk_url) > 130)) {
            throw new \InvalidArgumentException('invalid length for $supplier_clerk_url when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 130.');
        }
    ...
    public function setPaymentMethodsList($payment_methods_list)
    {
        ...
        if (!is_null($payment_methods_list) && (mb_strlen($payment_methods_list) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_methods_list when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setPaymentReason($payment_reason)
    {
        ...
        if (!is_null($payment_reason) && (mb_strlen($payment_reason) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_reason when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentTerms($payment_terms)
    {
        ...
        if (!is_null($payment_terms) && (mb_strlen($payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_terms when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setHouseBank($house_bank)
    {
        ...
        if (!is_null($house_bank) && (mb_strlen($house_bank) > 5)) {
            throw new \InvalidArgumentException('invalid length for $house_bank when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setSupplierClerkIdbySupplier($supplier_clerk_idby_supplier)
    {
        ...
        if (!is_null($supplier_clerk_idby_supplier) && (mb_strlen($supplier_clerk_idby_supplier) > 12)) {
            throw new \InvalidArgumentException('invalid length for $supplier_clerk_idby_supplier when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 12.');
        }
    ...
    public function setReconciliationAccount($reconciliation_account)
    {
        ...
        if (!is_null($reconciliation_account) && (mb_strlen($reconciliation_account) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reconciliation_account when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setInterestCalculationCode($interest_calculation_code)
    {
        ...
        if (!is_null($interest_calculation_code) && (mb_strlen($interest_calculation_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $interest_calculation_code when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setIntrstCalcFrequencyInMonths($intrst_calc_frequency_in_months)
    {
        ...
        if (!is_null($intrst_calc_frequency_in_months) && (mb_strlen($intrst_calc_frequency_in_months) > 2)) {
            throw new \InvalidArgumentException('invalid length for $intrst_calc_frequency_in_months when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setSupplierHeadOffice($supplier_head_office)
    {
        ...
        if (!is_null($supplier_head_office) && (mb_strlen($supplier_head_office) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier_head_office when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAlternativePayee($alternative_payee)
    {
        ...
        if (!is_null($alternative_payee) && (mb_strlen($alternative_payee) > 10)) {
            throw new \InvalidArgumentException('invalid length for $alternative_payee when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setLayoutSortingRule($layout_sorting_rule)
    {
        ...
        if (!is_null($layout_sorting_rule) && (mb_strlen($layout_sorting_rule) > 3)) {
            throw new \InvalidArgumentException('invalid length for $layout_sorting_rule when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setAparToleranceGroup($apar_tolerance_group)
    {
        ...
        if (!is_null($apar_tolerance_group) && (mb_strlen($apar_tolerance_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $apar_tolerance_group when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setSupplierAccountNote($supplier_account_note)
    {
        ...
        if (!is_null($supplier_account_note) && (mb_strlen($supplier_account_note) > 30)) {
            throw new \InvalidArgumentException('invalid length for $supplier_account_note when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 30.');
        }
    ...
    public function setWithholdingTaxCountry($withholding_tax_country)
    {
        ...
        if (!is_null($withholding_tax_country) && (mb_strlen($withholding_tax_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_country when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setCashPlanningGroup($cash_planning_group)
    {
        ...
        if (!is_null($cash_planning_group) && (mb_strlen($cash_planning_group) > 10)) {
            throw new \InvalidArgumentException('invalid length for $cash_planning_group when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setMinorityGroup($minority_group)
    {
        ...
        if (!is_null($minority_group) && (mb_strlen($minority_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $minority_group when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setSupplierAccountGroup($supplier_account_group)
    {
        ...
        if (!is_null($supplier_account_group) && (mb_strlen($supplier_account_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $supplier_account_group when calling APIBUSINESSPARTNERASupplierCompanyTypeCreate., must be smaller than or equal to 4.');
        }
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeCreateToCompanyText|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeCreateToCompanyText|null $to_company_text to_company_text
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeCreateToSupplierDunning|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeCreateToSupplierDunning|null $to_supplier_dunning to_supplier_dunning
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeCreateToSupplierWithHoldingTax|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeCreateToSupplierWithHoldingTax|null $to_supplier_with_holding_tax to_supplier_with_holding_tax
     *
     * @return self
     */
