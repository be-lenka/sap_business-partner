...
/**
 * APIBUSINESSPARTNERAAddressEmailAddressType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERAAddressEmailAddressType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_AddressEmailAddressType';
    ...
    protected static $setters = [
        ...
        'search_email_address' => 'setSearchEmailAddress',
    ...
    protected static $getters = [
        ...
        'search_email_address' => 'getSearchEmailAddress',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('search_email_address', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['search_email_address']) && (mb_strlen($this->container['search_email_address']) > 20)) {
            $invalidProperties[] = "invalid value for 'search_email_address', the character length must be smaller than or equal to 20.";
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if ((mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APIBUSINESSPARTNERAAddressEmailAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setPerson($person)
    {
        ...
        if ((mb_strlen($person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $person when calling APIBUSINESSPARTNERAAddressEmailAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setOrdinalNumber($ordinal_number)
    {
        ...
        if ((mb_strlen($ordinal_number) > 3)) {
            throw new \InvalidArgumentException('invalid length for $ordinal_number when calling APIBUSINESSPARTNERAAddressEmailAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if (!is_null($email_address) && (mb_strlen($email_address) > 241)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling APIBUSINESSPARTNERAAddressEmailAddressType., must be smaller than or equal to 241.');
        }
    ...
    /**
     * Gets search_email_address
     *
     * @return string|null
     */
    public function getSearchEmailAddress()
    {
        return $this->container['search_email_address'];
    }

    /**
     * Sets search_email_address
     *
     * @param string|null $search_email_address E-Mail Address Search Field
     *
     * @return self
     */
    public function setSearchEmailAddress($search_email_address)
    {
        if (is_null($search_email_address)) {
            array_push($this->openAPINullablesSetToNull, 'search_email_address');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('search_email_address', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($search_email_address) && (mb_strlen($search_email_address) > 20)) {
            throw new \InvalidArgumentException('invalid length for $search_email_address when calling APIBUSINESSPARTNERAAddressEmailAddressType., must be smaller than or equal to 20.');
        }

        $this->container['search_email_address'] = $search_email_address;
    ...
    public function setAddressCommunicationRemarkText($address_communication_remark_text)
    {
        ...
        if (!is_null($address_communication_remark_text) && (mb_strlen($address_communication_remark_text) > 50)) {
            throw new \InvalidArgumentException('invalid length for $address_communication_remark_text when calling APIBUSINESSPARTNERAAddressEmailAddressType., must be smaller than or equal to 50.');
        }
