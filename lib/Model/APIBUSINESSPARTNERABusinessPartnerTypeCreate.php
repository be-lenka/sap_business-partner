...
/**
 * APIBUSINESSPARTNERABusinessPartnerTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerType-create';
    ...
    protected static $openAPITypes = [
        ...
        'to_address_independent_email' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentEmail',
        'to_address_independent_fax' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentFax',
        'to_address_independent_mobile' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentMobile',
        'to_address_independent_phone' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentPhone',
        'to_address_independent_website' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentWebsite',
        'to_bp_credit_worthiness' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABPCreditWorthinessTypeCreate',
        'to_bp_data_controller' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPDataController',
        'to_bp_employment' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPEmployment',
        'to_bp_fin_services_reporting' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABPFinancialServicesReportingTypeCreate',
        'to_bp_fiscal_year_information' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPFiscalYearInformation',
        'to_bp_relationship' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPRelationship',
        'to_bu_pa_identification' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBuPaIdentification',
        'to_bu_pa_industry' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBuPaIndustry',
        'to_business_partner' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate',
        'to_business_partner_address' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerAddress',
        'to_business_partner_alias' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerAlias',
        'to_business_partner_bank' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerBank',
        'to_business_partner_contact' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerContact',
        'to_business_partner_is_bank' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerIsBankTypeCreate',
        'to_business_partner_rating' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerRating',
        'to_business_partner_role' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerRole',
        'to_business_partner_tax' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerTax',
        'to_bus_part_addr_depdnt_tax_nmbr' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusPartAddrDepdntTaxNmbr',
        'to_customer' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerTypeCreate',
        'to_payment_card' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToPaymentCard',
        'to_supplier' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreate'
    ];
    ...
    */
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAcademicTitle($academic_title)
    {
        ...
        if (!is_null($academic_title) && (mb_strlen($academic_title) > 4)) {
            throw new \InvalidArgumentException('invalid length for $academic_title when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBusinessPartnerCategory($business_partner_category)
    {
        ...
        if (!is_null($business_partner_category) && (mb_strlen($business_partner_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_category when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setBusinessPartnerGrouping($business_partner_grouping)
    {
        ...
        if (!is_null($business_partner_grouping) && (mb_strlen($business_partner_grouping) > 4)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_grouping when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setCorrespondenceLanguage($correspondence_language)
    {
        ...
        if (!is_null($correspondence_language) && (mb_strlen($correspondence_language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $correspondence_language when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setFormOfAddress($form_of_address)
    {
        ...
        if (!is_null($form_of_address) && (mb_strlen($form_of_address) > 4)) {
            throw new \InvalidArgumentException('invalid length for $form_of_address when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setIndustry($industry)
    {
        ...
        if (!is_null($industry) && (mb_strlen($industry) > 10)) {
            throw new \InvalidArgumentException('invalid length for $industry when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setInternationalLocationNumber1($international_location_number1)
    {
        ...
        if (!is_null($international_location_number1) && (mb_strlen($international_location_number1) > 7)) {
            throw new \InvalidArgumentException('invalid length for $international_location_number1 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 7.');
        }
    ...
    public function setInternationalLocationNumber2($international_location_number2)
    {
        ...
        if (!is_null($international_location_number2) && (mb_strlen($international_location_number2) > 5)) {
            throw new \InvalidArgumentException('invalid length for $international_location_number2 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setIsNaturalPerson($is_natural_person)
    {
        ...
        if (!is_null($is_natural_person) && (mb_strlen($is_natural_person) > 1)) {
            throw new \InvalidArgumentException('invalid length for $is_natural_person when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setGenderCodeName($gender_code_name)
    {
        ...
        if (!is_null($gender_code_name) && (mb_strlen($gender_code_name) > 1)) {
            throw new \InvalidArgumentException('invalid length for $gender_code_name when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if (!is_null($language) && (mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setLegalForm($legal_form)
    {
        ...
        if (!is_null($legal_form) && (mb_strlen($legal_form) > 2)) {
            throw new \InvalidArgumentException('invalid length for $legal_form when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setOrganizationBpName1($organization_bp_name1)
    {
        ...
        if (!is_null($organization_bp_name1) && (mb_strlen($organization_bp_name1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_bp_name1 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setOrganizationBpName2($organization_bp_name2)
    {
        ...
        if (!is_null($organization_bp_name2) && (mb_strlen($organization_bp_name2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_bp_name2 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setOrganizationBpName3($organization_bp_name3)
    {
        ...
        if (!is_null($organization_bp_name3) && (mb_strlen($organization_bp_name3) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_bp_name3 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setOrganizationBpName4($organization_bp_name4)
    {
        ...
        if (!is_null($organization_bp_name4) && (mb_strlen($organization_bp_name4) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_bp_name4 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setSearchTerm1($search_term1)
    {
        ...
        if (!is_null($search_term1) && (mb_strlen($search_term1) > 20)) {
            throw new \InvalidArgumentException('invalid length for $search_term1 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 20.');
        }
    ...
    public function setSearchTerm2($search_term2)
    {
        ...
        if (!is_null($search_term2) && (mb_strlen($search_term2) > 20)) {
            throw new \InvalidArgumentException('invalid length for $search_term2 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 20.');
        }
    ...
    public function setAdditionalLastName($additional_last_name)
    {
        ...
        if (!is_null($additional_last_name) && (mb_strlen($additional_last_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $additional_last_name when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessPartnerBirthDateStatus($business_partner_birth_date_status)
    {
        ...
        if (!is_null($business_partner_birth_date_status) && (mb_strlen($business_partner_birth_date_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_birth_date_status when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setBusinessPartnerBirthplaceName($business_partner_birthplace_name)
    {
        ...
        if (!is_null($business_partner_birthplace_name) && (mb_strlen($business_partner_birthplace_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_birthplace_name when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessPartnerType($business_partner_type)
    {
        ...
        if (!is_null($business_partner_type) && (mb_strlen($business_partner_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_type when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setGroupBusinessPartnerName1($group_business_partner_name1)
    {
        ...
        if (!is_null($group_business_partner_name1) && (mb_strlen($group_business_partner_name1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $group_business_partner_name1 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setGroupBusinessPartnerName2($group_business_partner_name2)
    {
        ...
        if (!is_null($group_business_partner_name2) && (mb_strlen($group_business_partner_name2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $group_business_partner_name2 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setInternationalLocationNumber3($international_location_number3)
    {
        ...
        if (!is_null($international_location_number3) && (mb_strlen($international_location_number3) > 1)) {
            throw new \InvalidArgumentException('invalid length for $international_location_number3 when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setMiddleName($middle_name)
    {
        ...
        if (!is_null($middle_name) && (mb_strlen($middle_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setNameCountry($name_country)
    {
        ...
        if (!is_null($name_country) && (mb_strlen($name_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $name_country when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setNameFormat($name_format)
    {
        ...
        if (!is_null($name_format) && (mb_strlen($name_format) > 2)) {
            throw new \InvalidArgumentException('invalid length for $name_format when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setPersonFullName($person_full_name)
    {
        ...
        if (!is_null($person_full_name) && (mb_strlen($person_full_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $person_full_name when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 80.');
        }
    ...
    public function setBusinessPartnerIdbyExtSystem($business_partner_idby_ext_system)
    {
        ...
        if (!is_null($business_partner_idby_ext_system) && (mb_strlen($business_partner_idby_ext_system) > 20)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_idby_ext_system when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 20.');
        }
    ...
    public function setBusinessPartnerPrintFormat($business_partner_print_format)
    {
        ...
        if (!is_null($business_partner_print_format) && (mb_strlen($business_partner_print_format) > 1)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_print_format when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setBusinessPartnerOccupation($business_partner_occupation)
    {
        ...
        if (!is_null($business_partner_occupation) && (mb_strlen($business_partner_occupation) > 4)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_occupation when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBusPartMaritalStatus($bus_part_marital_status)
    {
        ...
        if (!is_null($bus_part_marital_status) && (mb_strlen($bus_part_marital_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $bus_part_marital_status when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setBusPartNationality($bus_part_nationality)
    {
        ...
        if (!is_null($bus_part_nationality) && (mb_strlen($bus_part_nationality) > 3)) {
            throw new \InvalidArgumentException('invalid length for $bus_part_nationality when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setBusinessPartnerBirthName($business_partner_birth_name)
    {
        ...
        if (!is_null($business_partner_birth_name) && (mb_strlen($business_partner_birth_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_birth_name when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessPartnerSupplementName($business_partner_supplement_name)
    {
        ...
        if (!is_null($business_partner_supplement_name) && (mb_strlen($business_partner_supplement_name) > 4)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_supplement_name when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setNaturalPersonEmployerName($natural_person_employer_name)
    {
        ...
        if (!is_null($natural_person_employer_name) && (mb_strlen($natural_person_employer_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $natural_person_employer_name when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 35.');
        }
    ...
    public function setLastNamePrefix($last_name_prefix)
    {
        ...
        if (!is_null($last_name_prefix) && (mb_strlen($last_name_prefix) > 4)) {
            throw new \InvalidArgumentException('invalid length for $last_name_prefix when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setLastNameSecondPrefix($last_name_second_prefix)
    {
        ...
        if (!is_null($last_name_second_prefix) && (mb_strlen($last_name_second_prefix) > 4)) {
            throw new \InvalidArgumentException('invalid length for $last_name_second_prefix when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setInitials($initials)
    {
        ...
        if (!is_null($initials) && (mb_strlen($initials) > 10)) {
            throw new \InvalidArgumentException('invalid length for $initials when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setTradingPartner($trading_partner)
    {
        ...
        if (!is_null($trading_partner) && (mb_strlen($trading_partner) > 6)) {
            throw new \InvalidArgumentException('invalid length for $trading_partner when calling APIBUSINESSPARTNERABusinessPartnerTypeCreate., must be smaller than or equal to 6.');
        }
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentEmail|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentEmail|null $to_address_independent_email to_address_independent_email
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentFax|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentFax|null $to_address_independent_fax to_address_independent_fax
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentMobile|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentMobile|null $to_address_independent_mobile to_address_independent_mobile
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentPhone|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentPhone|null $to_address_independent_phone to_address_independent_phone
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentWebsite|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToAddressIndependentWebsite|null $to_address_independent_website to_address_independent_website
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABPCreditWorthinessTypeCreate|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABPCreditWorthinessTypeCreate|null $to_bp_credit_worthiness to_bp_credit_worthiness
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPDataController|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPDataController|null $to_bp_data_controller to_bp_data_controller
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPEmployment|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPEmployment|null $to_bp_employment to_bp_employment
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABPFinancialServicesReportingTypeCreate|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABPFinancialServicesReportingTypeCreate|null $to_bp_fin_services_reporting to_bp_fin_services_reporting
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPFiscalYearInformation|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPFiscalYearInformation|null $to_bp_fiscal_year_information to_bp_fiscal_year_information
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPRelationship|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBPRelationship|null $to_bp_relationship to_bp_relationship
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBuPaIdentification|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBuPaIdentification|null $to_bu_pa_identification to_bu_pa_identification
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBuPaIndustry|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBuPaIndustry|null $to_bu_pa_industry to_bu_pa_industry
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABPFinancialServicesExtnTypeCreate|null $to_business_partner to_business_partner
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerAddress|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerAddress|null $to_business_partner_address to_business_partner_address
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerAlias|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerAlias|null $to_business_partner_alias to_business_partner_alias
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerBank|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerBank|null $to_business_partner_bank to_business_partner_bank
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerContact|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerContact|null $to_business_partner_contact to_business_partner_contact
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerIsBankTypeCreate|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerIsBankTypeCreate|null $to_business_partner_is_bank to_business_partner_is_bank
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerRating|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerRating|null $to_business_partner_rating to_business_partner_rating
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerRole|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerRole|null $to_business_partner_role to_business_partner_role
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerTax|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusinessPartnerTax|null $to_business_partner_tax to_business_partner_tax
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusPartAddrDepdntTaxNmbr|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToBusPartAddrDepdntTaxNmbr|null $to_bus_part_addr_depdnt_tax_nmbr to_bus_part_addr_depdnt_tax_nmbr
     *
     * @return self
     */
     ...
     * Gets to_customer
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerTypeCreate|null
     */
     ...
     * Sets to_customer
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERACustomerTypeCreate|null $to_customer to_customer
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToPaymentCard|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERABusinessPartnerTypeCreateToPaymentCard|null $to_payment_card to_payment_card
     *
     * @return self
     */
     ...
     * Gets to_supplier
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreate|null
     */
     ...
     * Sets to_supplier
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierTypeCreate|null $to_supplier to_supplier
     *
     * @return self
     */
