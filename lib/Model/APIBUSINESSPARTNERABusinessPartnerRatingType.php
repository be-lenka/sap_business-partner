...
/**
 * APIBUSINESSPARTNERABusinessPartnerRatingType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerRatingType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerRatingType';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['business_partner_rating_procedure']) && (mb_strlen($this->container['business_partner_rating_procedure']) > 10)) {
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABusinessPartnerRatingType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string|null $business_partner_rating_procedure business_partner_rating_procedure
     *
     * @return self
     */
    public function setBusinessPartnerRatingProcedure($business_partner_rating_procedure)
    {
        ...
        if ((mb_strlen($business_partner_rating_procedure) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_rating_procedure when calling APIBUSINESSPARTNERABusinessPartnerRatingType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string|null $bp_rating_validity_end_date Valid-to Date for Rating
     *
     * @return self
     */
    ...
    public function setBusinessPartnerRatingGrade($business_partner_rating_grade)
    {
        ...
        if (!is_null($business_partner_rating_grade) && (mb_strlen($business_partner_rating_grade) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_rating_grade when calling APIBUSINESSPARTNERABusinessPartnerRatingType., must be smaller than or equal to 10.');
        }
    ...
    public function setBusinessPartnerRatingTrend($business_partner_rating_trend)
    {
        ...
        if (!is_null($business_partner_rating_trend) && (mb_strlen($business_partner_rating_trend) > 2)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_rating_trend when calling APIBUSINESSPARTNERABusinessPartnerRatingType., must be smaller than or equal to 2.');
        }
    ...
    public function setBusinessPartnerRatingComment($business_partner_rating_comment)
    {
        ...
        if (!is_null($business_partner_rating_comment) && (mb_strlen($business_partner_rating_comment) > 60)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_rating_comment when calling APIBUSINESSPARTNERABusinessPartnerRatingType., must be smaller than or equal to 60.');
        }
    ...
    public function setBpRatingLongComment($bp_rating_long_comment)
    {
        ...
        if (!is_null($bp_rating_long_comment) && (mb_strlen($bp_rating_long_comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bp_rating_long_comment when calling APIBUSINESSPARTNERABusinessPartnerRatingType., must be smaller than or equal to 255.');
        }
