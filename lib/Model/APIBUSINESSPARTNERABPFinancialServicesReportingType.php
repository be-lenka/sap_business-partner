...
/**
 * APIBUSINESSPARTNERABPFinancialServicesReportingType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABPFinancialServicesReportingType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BPFinancialServicesReportingType';
    ...
    */
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 10.');
        }
    ...
    public function setBpLoanReportingBorrowerNumber($bp_loan_reporting_borrower_number)
    {
        ...
        if (!is_null($bp_loan_reporting_borrower_number) && (mb_strlen($bp_loan_reporting_borrower_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $bp_loan_reporting_borrower_number when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 8.');
        }
    ...
    public function setBpLoanRptgBorrowerEntityNumber($bp_loan_rptg_borrower_entity_number)
    {
        ...
        if (!is_null($bp_loan_rptg_borrower_entity_number) && (mb_strlen($bp_loan_rptg_borrower_entity_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $bp_loan_rptg_borrower_entity_number when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 8.');
        }
    ...
    public function setBpCreditStandingReview($bp_credit_standing_review)
    {
        ...
        if (!is_null($bp_credit_standing_review) && (mb_strlen($bp_credit_standing_review) > 2)) {
            throw new \InvalidArgumentException('invalid length for $bp_credit_standing_review when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 2.');
        }
    ...
    public function setBusinessPartnerLoanToManager($business_partner_loan_to_manager)
    {
        ...
        if (!is_null($business_partner_loan_to_manager) && (mb_strlen($business_partner_loan_to_manager) > 2)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_loan_to_manager when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 2.');
        }
    ...
    public function setBpCompanyRelationship($bp_company_relationship)
    {
        ...
        if (!is_null($bp_company_relationship) && (mb_strlen($bp_company_relationship) > 1)) {
            throw new \InvalidArgumentException('invalid length for $bp_company_relationship when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 1.');
        }
    ...
    public function setBpLoanReportingCreditorNumber($bp_loan_reporting_creditor_number)
    {
        ...
        if (!is_null($bp_loan_reporting_creditor_number) && (mb_strlen($bp_loan_reporting_creditor_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $bp_loan_reporting_creditor_number when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 8.');
        }
    ...
    public function setBpoeNbIdentNumber($bpoe_nb_ident_number)
    {
        ...
        if (!is_null($bpoe_nb_ident_number) && (mb_strlen($bpoe_nb_ident_number) > 11)) {
            throw new \InvalidArgumentException('invalid length for $bpoe_nb_ident_number when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 11.');
        }
    ...
    public function setBpoeNbTargetGroup($bpoe_nb_target_group)
    {
        ...
        if (!is_null($bpoe_nb_target_group) && (mb_strlen($bpoe_nb_target_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $bpoe_nb_target_group when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 2.');
        }
    ...
    public function setBpoeNbIdentNumberAssigned($bpoe_nb_ident_number_assigned)
    {
        ...
        if (!is_null($bpoe_nb_ident_number_assigned) && (mb_strlen($bpoe_nb_ident_number_assigned) > 1)) {
            throw new \InvalidArgumentException('invalid length for $bpoe_nb_ident_number_assigned when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 1.');
        }
    ...
    public function setBpoeNbInstituteNumber($bpoe_nb_institute_number)
    {
        ...
        if (!is_null($bpoe_nb_institute_number) && (mb_strlen($bpoe_nb_institute_number) > 7)) {
            throw new \InvalidArgumentException('invalid length for $bpoe_nb_institute_number when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 7.');
        }
    ...
    public function setBusinessPartnerGroup($business_partner_group)
    {
        ...
        if (!is_null($business_partner_group) && (mb_strlen($business_partner_group) > 15)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_group when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 15.');
        }
    ...
    public function setBpGroupAssignmentCategory($bp_group_assignment_category)
    {
        ...
        if (!is_null($bp_group_assignment_category) && (mb_strlen($bp_group_assignment_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $bp_group_assignment_category when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 1.');
        }
    ...
    public function setBusinessPartnerGroupName($business_partner_group_name)
    {
        ...
        if (!is_null($business_partner_group_name) && (mb_strlen($business_partner_group_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_group_name when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 50.');
        }
    ...
    public function setBusinessPartnerLegalEntity($business_partner_legal_entity)
    {
        ...
        if (!is_null($business_partner_legal_entity) && (mb_strlen($business_partner_legal_entity) > 2)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_legal_entity when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 2.');
        }
    ...
    public function setBpGerAstRglnRestrictedAstQuota($bp_ger_ast_rgln_restricted_ast_quota)
    {
        ...
        if (!is_null($bp_ger_ast_rgln_restricted_ast_quota) && (mb_strlen($bp_ger_ast_rgln_restricted_ast_quota) > 1)) {
            throw new \InvalidArgumentException('invalid length for $bp_ger_ast_rgln_restricted_ast_quota when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 1.');
        }
    ...
    public function setBusinessPartnerDebtorGroup($business_partner_debtor_group)
    {
        ...
        if (!is_null($business_partner_debtor_group) && (mb_strlen($business_partner_debtor_group) > 1)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_debtor_group when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 1.');
        }
    ...
    public function setBusinessPartnerBusinessPurpose($business_partner_business_purpose)
    {
        ...
        if (!is_null($business_partner_business_purpose) && (mb_strlen($business_partner_business_purpose) > 2)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_business_purpose when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 2.');
        }
    ...
    public function setBusinessPartnerRiskGroup($business_partner_risk_group)
    {
        ...
        if (!is_null($business_partner_risk_group) && (mb_strlen($business_partner_risk_group) > 1)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_risk_group when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 1.');
        }
    ...
    public function setBpCentralBankCountryRegion($bp_central_bank_country_region)
    {
        ...
        if (!is_null($bp_central_bank_country_region) && (mb_strlen($bp_central_bank_country_region) > 4)) {
            throw new \InvalidArgumentException('invalid length for $bp_central_bank_country_region when calling APIBUSINESSPARTNERABPFinancialServicesReportingType., must be smaller than or equal to 4.');
        }
