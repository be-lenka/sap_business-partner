<?php
/**
 * APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BPContactToFuncAndDeptType-create';
    ...
    */
    ...
    public function setRelationshipNumber($relationship_number)
    {
        ...
        if ((mb_strlen($relationship_number) > 12)) {
            throw new \InvalidArgumentException('invalid length for $relationship_number when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 12.');
        }
    ...
    public function setBusinessPartnerCompany($business_partner_company)
    {
        ...
        if ((mb_strlen($business_partner_company) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_company when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setBusinessPartnerPerson($business_partner_person)
    {
        ...
        if ((mb_strlen($business_partner_person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_person when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setContactPersonAuthorityType($contact_person_authority_type)
    {
        ...
        if (!is_null($contact_person_authority_type) && (mb_strlen($contact_person_authority_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $contact_person_authority_type when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setContactPersonDepartment($contact_person_department)
    {
        ...
        if (!is_null($contact_person_department) && (mb_strlen($contact_person_department) > 4)) {
            throw new \InvalidArgumentException('invalid length for $contact_person_department when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setContactPersonDepartmentName($contact_person_department_name)
    {
        ...
        if (!is_null($contact_person_department_name) && (mb_strlen($contact_person_department_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $contact_person_department_name when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setContactPersonFunction($contact_person_function)
    {
        ...
        if (!is_null($contact_person_function) && (mb_strlen($contact_person_function) > 4)) {
            throw new \InvalidArgumentException('invalid length for $contact_person_function when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setContactPersonFunctionName($contact_person_function_name)
    {
        ...
        if (!is_null($contact_person_function_name) && (mb_strlen($contact_person_function_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $contact_person_function_name when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setContactPersonRemarkText($contact_person_remark_text)
    {
        ...
        if (!is_null($contact_person_remark_text) && (mb_strlen($contact_person_remark_text) > 40)) {
            throw new \InvalidArgumentException('invalid length for $contact_person_remark_text when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setContactPersonVipType($contact_person_vip_type)
    {
        ...
        if (!is_null($contact_person_vip_type) && (mb_strlen($contact_person_vip_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $contact_person_vip_type when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if (!is_null($email_address) && (mb_strlen($email_address) > 241)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 241.');
        }
    ...
    public function setFaxNumber($fax_number)
    {
        ...
        if (!is_null($fax_number) && (mb_strlen($fax_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $fax_number when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 30.');
        }
    ...
    public function setFaxNumberExtension($fax_number_extension)
    {
        ...
        if (!is_null($fax_number_extension) && (mb_strlen($fax_number_extension) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fax_number_extension when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 30.');
        }
    ...
    public function setPhoneNumberExtension($phone_number_extension)
    {
        ...
        if (!is_null($phone_number_extension) && (mb_strlen($phone_number_extension) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_extension when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setRelationshipCategory($relationship_category)
    {
        ...
        if (!is_null($relationship_category) && (mb_strlen($relationship_category) > 6)) {
            throw new \InvalidArgumentException('invalid length for $relationship_category when calling APIBUSINESSPARTNERABPContactToFuncAndDeptTypeCreate., must be smaller than or equal to 6.');
        }
