...
/**
 * APIBUSINESSPARTNERABusinessPartnerBankTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerBankTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerBankType-create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bank_identification'] === null) {
            $invalidProperties[] = "'bank_identification' can't be null";
        }
        if ((mb_strlen($this->container['bank_identification']) > 4)) {
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string $bank_identification bank_identification
     *
     * @return self
     */
    public function setBankIdentification($bank_identification)
    {
        ...
        if ((mb_strlen($bank_identification) > 4)) {
            throw new \InvalidArgumentException('invalid length for $bank_identification when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBankCountryKey($bank_country_key)
    {
        ...
        if (!is_null($bank_country_key) && (mb_strlen($bank_country_key) > 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_country_key when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setBankNumber($bank_number)
    {
        ...
        if (!is_null($bank_number) && (mb_strlen($bank_number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $bank_number when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 15.');
        }
    ...
    public function setBankControlKey($bank_control_key)
    {
        ...
        if (!is_null($bank_control_key) && (mb_strlen($bank_control_key) > 2)) {
            throw new \InvalidArgumentException('invalid length for $bank_control_key when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setBankAccountHolderName($bank_account_holder_name)
    {
        ...
        if (!is_null($bank_account_holder_name) && (mb_strlen($bank_account_holder_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_holder_name when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 60.');
        }
    ...
    public function setBankAccountName($bank_account_name)
    {
        ...
        if (!is_null($bank_account_name) && (mb_strlen($bank_account_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_name when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setIban($iban)
    {
        ...
        if (!is_null($iban) && (mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 34.');
        }
    ...
    public function setBankAccount($bank_account)
    {
        ...
        if (!is_null($bank_account) && (mb_strlen($bank_account) > 18)) {
            throw new \InvalidArgumentException('invalid length for $bank_account when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 18.');
        }
    ...
    public function setBankAccountReferenceText($bank_account_reference_text)
    {
        ...
        if (!is_null($bank_account_reference_text) && (mb_strlen($bank_account_reference_text) > 20)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_reference_text when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 20.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERABusinessPartnerBankTypeCreate., must be smaller than or equal to 4.');
        }
