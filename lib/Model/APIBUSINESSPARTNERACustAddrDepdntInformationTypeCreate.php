...
/**
 * APIBUSINESSPARTNERACustAddrDepdntInformationTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustAddrDepdntInformationTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustAddrDepdntInformationType-create';
    ...
    */
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIBUSINESSPARTNERACustAddrDepdntInformationTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if ((mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APIBUSINESSPARTNERACustAddrDepdntInformationTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setExpressTrainStationName($express_train_station_name)
    {
        ...
        if (!is_null($express_train_station_name) && (mb_strlen($express_train_station_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $express_train_station_name when calling APIBUSINESSPARTNERACustAddrDepdntInformationTypeCreate., must be smaller than or equal to 25.');
        }
    ...
    public function setTrainStationName($train_station_name)
    {
        ...
        if (!is_null($train_station_name) && (mb_strlen($train_station_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $train_station_name when calling APIBUSINESSPARTNERACustAddrDepdntInformationTypeCreate., must be smaller than or equal to 25.');
        }
    ...
    public function setCityCode($city_code)
    {
        ...
        if (!is_null($city_code) && (mb_strlen($city_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $city_code when calling APIBUSINESSPARTNERACustAddrDepdntInformationTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setCounty($county)
    {
        ...
        if (!is_null($county) && (mb_strlen($county) > 3)) {
            throw new \InvalidArgumentException('invalid length for $county when calling APIBUSINESSPARTNERACustAddrDepdntInformationTypeCreate., must be smaller than or equal to 3.');
        }
