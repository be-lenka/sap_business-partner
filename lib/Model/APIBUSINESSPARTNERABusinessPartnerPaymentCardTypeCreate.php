...
/**
 * APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerPaymentCardType-create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_card_id'] === null) {
            $invalidProperties[] = "'payment_card_id' can't be null";
        }
        if ((mb_strlen($this->container['payment_card_id']) > 6)) {
            $invalidProperties[] = "invalid value for 'payment_card_id', the character length must be smaller than or equal to 6.";
        }

        if ($this->container['payment_card_type'] === null) {
            $invalidProperties[] = "'payment_card_type' can't be null";
        }
        if ((mb_strlen($this->container['payment_card_type']) > 4)) {
        ...
        if ((mb_strlen($this->container['card_number']) > 25)) {
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string $payment_card_id payment_card_id
     *
     * @return self
     */
    public function setPaymentCardId($payment_card_id)
    {
        ...
        if ((mb_strlen($payment_card_id) > 6)) {
            throw new \InvalidArgumentException('invalid length for $payment_card_id when calling APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate., must be smaller than or equal to 6.');
        }
     ...
     *
     * @param string $payment_card_type payment_card_type
     *
     * @return self
     */
    public function setPaymentCardType($payment_card_type)
    {
        ...
        if ((mb_strlen($payment_card_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_card_type when calling APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate., must be smaller than or equal to 4.');
        }
     ...
     * Sets card_number
     *
     * @param string $card_number Payment Cards: Card Number
     *
     * @return self
     */
    public function setCardNumber($card_number)
    {
        ...
        if ((mb_strlen($card_number) > 25)) {
            throw new \InvalidArgumentException('invalid length for $card_number when calling APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate., must be smaller than or equal to 25.');
        }
    ...
    public function setCardDescription($card_description)
    {
        ...
        if (!is_null($card_description) && (mb_strlen($card_description) > 40)) {
            throw new \InvalidArgumentException('invalid length for $card_description when calling APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setCardHolder($card_holder)
    {
        ...
        if (!is_null($card_holder) && (mb_strlen($card_holder) > 40)) {
            throw new \InvalidArgumentException('invalid length for $card_holder when calling APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setCardIssuingBank($card_issuing_bank)
    {
        ...
        if (!is_null($card_issuing_bank) && (mb_strlen($card_issuing_bank) > 40)) {
            throw new \InvalidArgumentException('invalid length for $card_issuing_bank when calling APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setPaymentCardLock($payment_card_lock)
    {
        ...
        if (!is_null($payment_card_lock) && (mb_strlen($payment_card_lock) > 2)) {
            throw new \InvalidArgumentException('invalid length for $payment_card_lock when calling APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setMaskedCardNumber($masked_card_number)
    {
        ...
        if (!is_null($masked_card_number) && (mb_strlen($masked_card_number) > 25)) {
            throw new \InvalidArgumentException('invalid length for $masked_card_number when calling APIBUSINESSPARTNERABusinessPartnerPaymentCardTypeCreate., must be smaller than or equal to 25.');
        }
