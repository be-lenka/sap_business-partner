...
/**
 * APIBUSINESSPARTNERABPAddressIndependentFaxTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABPAddressIndependentFaxTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BPAddressIndependentFaxType-create';
    ...
    */
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABPAddressIndependentFaxTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if ((mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APIBUSINESSPARTNERABPAddressIndependentFaxTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setPerson($person)
    {
        ...
        if ((mb_strlen($person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $person when calling APIBUSINESSPARTNERABPAddressIndependentFaxTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setOrdinalNumber($ordinal_number)
    {
        ...
        if ((mb_strlen($ordinal_number) > 3)) {
            throw new \InvalidArgumentException('invalid length for $ordinal_number when calling APIBUSINESSPARTNERABPAddressIndependentFaxTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setFaxCountry($fax_country)
    {
        ...
        if (!is_null($fax_country) && (mb_strlen($fax_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $fax_country when calling APIBUSINESSPARTNERABPAddressIndependentFaxTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setFaxAreaCodeSubscriberNumber($fax_area_code_subscriber_number)
    {
        ...
        if (!is_null($fax_area_code_subscriber_number) && (mb_strlen($fax_area_code_subscriber_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $fax_area_code_subscriber_number when calling APIBUSINESSPARTNERABPAddressIndependentFaxTypeCreate., must be smaller than or equal to 30.');
        }
    ...
    public function setFaxNumberExtension($fax_number_extension)
    {
        ...
        if (!is_null($fax_number_extension) && (mb_strlen($fax_number_extension) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fax_number_extension when calling APIBUSINESSPARTNERABPAddressIndependentFaxTypeCreate., must be smaller than or equal to 10.');
        }
