...
/**
 * APIBUSINESSPARTNERABusinessPartnerAliasTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerAliasTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerAliasType-update';
    ...
    */
    ...
    public function setBusinessPartnerAliasName($business_partner_alias_name)
    {
        ...
        if (!is_null($business_partner_alias_name) && (mb_strlen($business_partner_alias_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_alias_name when calling APIBUSINESSPARTNERABusinessPartnerAliasTypeUpdate., must be smaller than or equal to 80.');
        }
