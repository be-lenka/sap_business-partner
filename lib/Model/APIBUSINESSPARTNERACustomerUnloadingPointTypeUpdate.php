...
/**
 * APIBUSINESSPARTNERACustomerUnloadingPointTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustomerUnloadingPointTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustomerUnloadingPointType-update';
    ...
    */
    ...
    public function setCustomerFactoryCalenderCode($customer_factory_calender_code)
    {
        ...
        if (!is_null($customer_factory_calender_code) && (mb_strlen($customer_factory_calender_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_factory_calender_code when calling APIBUSINESSPARTNERACustomerUnloadingPointTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setBpGoodsReceivingHoursCode($bp_goods_receiving_hours_code)
    {
        ...
        if (!is_null($bp_goods_receiving_hours_code) && (mb_strlen($bp_goods_receiving_hours_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $bp_goods_receiving_hours_code when calling APIBUSINESSPARTNERACustomerUnloadingPointTypeUpdate., must be smaller than or equal to 3.');
        }
