...
/**
 * APIBUSINESSPARTNERAAddressFaxNumberType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERAAddressFaxNumberType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_AddressFaxNumberType';
    ...
    */
    ...
    public function setAddressId($address_id)
    {
        ...
        if ((mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APIBUSINESSPARTNERAAddressFaxNumberType., must be smaller than or equal to 10.');
        }
    ...
    public function setPerson($person)
    {
        ...
        if ((mb_strlen($person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $person when calling APIBUSINESSPARTNERAAddressFaxNumberType., must be smaller than or equal to 10.');
        }
    ...
    public function setOrdinalNumber($ordinal_number)
    {
        ...
        if ((mb_strlen($ordinal_number) > 3)) {
            throw new \InvalidArgumentException('invalid length for $ordinal_number when calling APIBUSINESSPARTNERAAddressFaxNumberType., must be smaller than or equal to 3.');
        }
    ...
    public function setFaxCountry($fax_country)
    {
        ...
        if (!is_null($fax_country) && (mb_strlen($fax_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $fax_country when calling APIBUSINESSPARTNERAAddressFaxNumberType., must be smaller than or equal to 3.');
        }
    ...
    public function setFaxNumber($fax_number)
    {
        ...
        if (!is_null($fax_number) && (mb_strlen($fax_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $fax_number when calling APIBUSINESSPARTNERAAddressFaxNumberType., must be smaller than or equal to 30.');
        }
    ...
    public function setFaxNumberExtension($fax_number_extension)
    {
        ...
        if (!is_null($fax_number_extension) && (mb_strlen($fax_number_extension) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fax_number_extension when calling APIBUSINESSPARTNERAAddressFaxNumberType., must be smaller than or equal to 10.');
        }
    ...
    public function setInternationalFaxNumber($international_fax_number)
    {
        ...
        if (!is_null($international_fax_number) && (mb_strlen($international_fax_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $international_fax_number when calling APIBUSINESSPARTNERAAddressFaxNumberType., must be smaller than or equal to 30.');
        }
    ...
    public function setAddressCommunicationRemarkText($address_communication_remark_text)
    {
        ...
        if (!is_null($address_communication_remark_text) && (mb_strlen($address_communication_remark_text) > 50)) {
            throw new \InvalidArgumentException('invalid length for $address_communication_remark_text when calling APIBUSINESSPARTNERAAddressFaxNumberType., must be smaller than or equal to 50.');
        }
