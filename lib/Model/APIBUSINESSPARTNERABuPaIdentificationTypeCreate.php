...
/**
 * APIBUSINESSPARTNERABuPaIdentificationTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABuPaIdentificationTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BuPaIdentificationType-create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bp_identification_type'] === null) {
            $invalidProperties[] = "'bp_identification_type' can't be null";
        }
        if ((mb_strlen($this->container['bp_identification_type']) > 6)) {
            $invalidProperties[] = "invalid value for 'bp_identification_type', the character length must be smaller than or equal to 6.";
        }

        if ($this->container['bp_identification_number'] === null) {
            $invalidProperties[] = "'bp_identification_number' can't be null";
        }
        if ((mb_strlen($this->container['bp_identification_number']) > 60)) {
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABuPaIdentificationTypeCreate., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string $bp_identification_type bp_identification_type
     *
     * @return self
     */
    public function setBpIdentificationType($bp_identification_type)
    {
        ...
        if ((mb_strlen($bp_identification_type) > 6)) {
            throw new \InvalidArgumentException('invalid length for $bp_identification_type when calling APIBUSINESSPARTNERABuPaIdentificationTypeCreate., must be smaller than or equal to 6.');
        }
     ...
     *
     * @param string $bp_identification_number Identification Number
     *
     * @return self
     */
    public function setBpIdentificationNumber($bp_identification_number)
    {
        ...
        if ((mb_strlen($bp_identification_number) > 60)) {
            throw new \InvalidArgumentException('invalid length for $bp_identification_number when calling APIBUSINESSPARTNERABuPaIdentificationTypeCreate., must be smaller than or equal to 60.');
        }
    ...
    public function setBpIdnNmbrIssuingInstitute($bp_idn_nmbr_issuing_institute)
    {
        ...
        if (!is_null($bp_idn_nmbr_issuing_institute) && (mb_strlen($bp_idn_nmbr_issuing_institute) > 40)) {
            throw new \InvalidArgumentException('invalid length for $bp_idn_nmbr_issuing_institute when calling APIBUSINESSPARTNERABuPaIdentificationTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling APIBUSINESSPARTNERABuPaIdentificationTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $region when calling APIBUSINESSPARTNERABuPaIdentificationTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERABuPaIdentificationTypeCreate., must be smaller than or equal to 4.');
        }
