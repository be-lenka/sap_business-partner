...
/**
 * APIBUSINESSPARTNERABPFiscalYearInformationTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABPFiscalYearInformationTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BPFiscalYearInformationType-create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['business_partner_fiscal_year'] === null) {
            $invalidProperties[] = "'business_partner_fiscal_year' can't be null";
        }
        if ((mb_strlen($this->container['business_partner_fiscal_year']) > 4)) {
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABPFiscalYearInformationTypeCreate., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string $business_partner_fiscal_year business_partner_fiscal_year
     *
     * @return self
     */
    public function setBusinessPartnerFiscalYear($business_partner_fiscal_year)
    {
        ...
        if ((mb_strlen($business_partner_fiscal_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_fiscal_year when calling APIBUSINESSPARTNERABPFiscalYearInformationTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBpBalanceSheetCurrency($bp_balance_sheet_currency)
    {
        ...
        if (!is_null($bp_balance_sheet_currency) && (mb_strlen($bp_balance_sheet_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $bp_balance_sheet_currency when calling APIBUSINESSPARTNERABPFiscalYearInformationTypeCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setBpNumberOfEmployees($bp_number_of_employees)
    {
        ...
        if (!is_null($bp_number_of_employees) && (mb_strlen($bp_number_of_employees) > 7)) {
            throw new \InvalidArgumentException('invalid length for $bp_number_of_employees when calling APIBUSINESSPARTNERABPFiscalYearInformationTypeCreate., must be smaller than or equal to 7.');
        }
