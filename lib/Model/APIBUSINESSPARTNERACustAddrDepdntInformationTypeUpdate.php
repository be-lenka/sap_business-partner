...
/**
 * APIBUSINESSPARTNERACustAddrDepdntInformationTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustAddrDepdntInformationTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustAddrDepdntInformationType-update';
    ...
    */
    ...
    public function setExpressTrainStationName($express_train_station_name)
    {
        ...
        if (!is_null($express_train_station_name) && (mb_strlen($express_train_station_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $express_train_station_name when calling APIBUSINESSPARTNERACustAddrDepdntInformationTypeUpdate., must be smaller than or equal to 25.');
        }
    ...
    public function setTrainStationName($train_station_name)
    {
        ...
        if (!is_null($train_station_name) && (mb_strlen($train_station_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $train_station_name when calling APIBUSINESSPARTNERACustAddrDepdntInformationTypeUpdate., must be smaller than or equal to 25.');
        }
    ...
    public function setCityCode($city_code)
    {
        ...
        if (!is_null($city_code) && (mb_strlen($city_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $city_code when calling APIBUSINESSPARTNERACustAddrDepdntInformationTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setCounty($county)
    {
        ...
        if (!is_null($county) && (mb_strlen($county) > 3)) {
            throw new \InvalidArgumentException('invalid length for $county when calling APIBUSINESSPARTNERACustAddrDepdntInformationTypeUpdate., must be smaller than or equal to 3.');
        }
