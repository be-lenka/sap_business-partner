...
/**
 * APIBUSINESSPARTNERACustomerCompanyTextTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustomerCompanyTextTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustomerCompanyTextType-create';
    ...
    */
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIBUSINESSPARTNERACustomerCompanyTextTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setCompanyCode($company_code)
    {
        ...
        if ((mb_strlen($company_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling APIBUSINESSPARTNERACustomerCompanyTextTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling APIBUSINESSPARTNERACustomerCompanyTextTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setLongTextId($long_text_id)
    {
        ...
        if ((mb_strlen($long_text_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $long_text_id when calling APIBUSINESSPARTNERACustomerCompanyTextTypeCreate., must be smaller than or equal to 4.');
        }
