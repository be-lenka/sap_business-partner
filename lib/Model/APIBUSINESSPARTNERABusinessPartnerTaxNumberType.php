...
/**
 * APIBUSINESSPARTNERABusinessPartnerTaxNumberType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerTaxNumberType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerTaxNumberType';
    ...
    */
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABusinessPartnerTaxNumberType., must be smaller than or equal to 10.');
        }
    ...
    public function setBpTaxType($bp_tax_type)
    {
        ...
        if ((mb_strlen($bp_tax_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $bp_tax_type when calling APIBUSINESSPARTNERABusinessPartnerTaxNumberType., must be smaller than or equal to 4.');
        }
    ...
    public function setBpTaxNumber($bp_tax_number)
    {
        ...
        if (!is_null($bp_tax_number) && (mb_strlen($bp_tax_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $bp_tax_number when calling APIBUSINESSPARTNERABusinessPartnerTaxNumberType., must be smaller than or equal to 20.');
        }
    ...
    public function setBpTaxLongNumber($bp_tax_long_number)
    {
        ...
        if (!is_null($bp_tax_long_number) && (mb_strlen($bp_tax_long_number) > 60)) {
            throw new \InvalidArgumentException('invalid length for $bp_tax_long_number when calling APIBUSINESSPARTNERABusinessPartnerTaxNumberType., must be smaller than or equal to 60.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERABusinessPartnerTaxNumberType., must be smaller than or equal to 4.');
        }
