...
/**
 * APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerAddressType-update';
    ...
    */
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setAdditionalStreetPrefixName($additional_street_prefix_name)
    {
        ...
        if (!is_null($additional_street_prefix_name) && (mb_strlen($additional_street_prefix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $additional_street_prefix_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setAdditionalStreetSuffixName($additional_street_suffix_name)
    {
        ...
        if (!is_null($additional_street_suffix_name) && (mb_strlen($additional_street_suffix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $additional_street_suffix_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setAddressTimeZone($address_time_zone)
    {
        ...
        if (!is_null($address_time_zone) && (mb_strlen($address_time_zone) > 6)) {
            throw new \InvalidArgumentException('invalid length for $address_time_zone when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setCareOfName($care_of_name)
    {
        ...
        if (!is_null($care_of_name) && (mb_strlen($care_of_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $care_of_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setCityCode($city_code)
    {
        ...
        if (!is_null($city_code) && (mb_strlen($city_code) > 12)) {
            throw new \InvalidArgumentException('invalid length for $city_code when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 12.');
        }
    ...
    public function setCityName($city_name)
    {
        ...
        if (!is_null($city_name) && (mb_strlen($city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setCompanyPostalCode($company_postal_code)
    {
        ...
        if (!is_null($company_postal_code) && (mb_strlen($company_postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $company_postal_code when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setCounty($county)
    {
        ...
        if (!is_null($county) && (mb_strlen($county) > 40)) {
            throw new \InvalidArgumentException('invalid length for $county when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setDeliveryServiceNumber($delivery_service_number)
    {
        ...
        if (!is_null($delivery_service_number) && (mb_strlen($delivery_service_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $delivery_service_number when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryServiceTypeCode($delivery_service_type_code)
    {
        ...
        if (!is_null($delivery_service_type_code) && (mb_strlen($delivery_service_type_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $delivery_service_type_code when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setDistrict($district)
    {
        ...
        if (!is_null($district) && (mb_strlen($district) > 40)) {
            throw new \InvalidArgumentException('invalid length for $district when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setHomeCityName($home_city_name)
    {
        ...
        if (!is_null($home_city_name) && (mb_strlen($home_city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $home_city_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setHouseNumber($house_number)
    {
        ...
        if (!is_null($house_number) && (mb_strlen($house_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $house_number when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setHouseNumberSupplementText($house_number_supplement_text)
    {
        ...
        if (!is_null($house_number_supplement_text) && (mb_strlen($house_number_supplement_text) > 10)) {
            throw new \InvalidArgumentException('invalid length for $house_number_supplement_text when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if (!is_null($language) && (mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setPoBox($po_box)
    {
        ...
        if (!is_null($po_box) && (mb_strlen($po_box) > 10)) {
            throw new \InvalidArgumentException('invalid length for $po_box when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPoBoxDeviatingCityName($po_box_deviating_city_name)
    {
        ...
        if (!is_null($po_box_deviating_city_name) && (mb_strlen($po_box_deviating_city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $po_box_deviating_city_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setPoBoxDeviatingCountry($po_box_deviating_country)
    {
        ...
        if (!is_null($po_box_deviating_country) && (mb_strlen($po_box_deviating_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $po_box_deviating_country when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setPoBoxDeviatingRegion($po_box_deviating_region)
    {
        ...
        if (!is_null($po_box_deviating_region) && (mb_strlen($po_box_deviating_region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $po_box_deviating_region when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setPoBoxLobbyName($po_box_lobby_name)
    {
        ...
        if (!is_null($po_box_lobby_name) && (mb_strlen($po_box_lobby_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $po_box_lobby_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setPoBoxPostalCode($po_box_postal_code)
    {
        ...
        if (!is_null($po_box_postal_code) && (mb_strlen($po_box_postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $po_box_postal_code when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPrfrdCommMediumType($prfrd_comm_medium_type)
    {
        ...
        if (!is_null($prfrd_comm_medium_type) && (mb_strlen($prfrd_comm_medium_type) > 3)) {
            throw new \InvalidArgumentException('invalid length for $prfrd_comm_medium_type when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $region when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setStreetName($street_name)
    {
        ...
        if (!is_null($street_name) && (mb_strlen($street_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $street_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 60.');
        }
    ...
    public function setStreetPrefixName($street_prefix_name)
    {
        ...
        if (!is_null($street_prefix_name) && (mb_strlen($street_prefix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_prefix_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetSuffixName($street_suffix_name)
    {
        ...
        if (!is_null($street_suffix_name) && (mb_strlen($street_suffix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_suffix_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setTaxJurisdiction($tax_jurisdiction)
    {
        ...
        if (!is_null($tax_jurisdiction) && (mb_strlen($tax_jurisdiction) > 15)) {
            throw new \InvalidArgumentException('invalid length for $tax_jurisdiction when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 15.');
        }
    ...
    public function setTransportZone($transport_zone)
    {
        ...
        if (!is_null($transport_zone) && (mb_strlen($transport_zone) > 10)) {
            throw new \InvalidArgumentException('invalid length for $transport_zone when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressIdbyExternalSystem($address_idby_external_system)
    {
        ...
        if (!is_null($address_idby_external_system) && (mb_strlen($address_idby_external_system) > 20)) {
            throw new \InvalidArgumentException('invalid length for $address_idby_external_system when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 20.');
        }
    ...
    public function setCountyCode($county_code)
    {
        ...
        if (!is_null($county_code) && (mb_strlen($county_code) > 8)) {
            throw new \InvalidArgumentException('invalid length for $county_code when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 8.');
        }
    ...
    public function setTownshipCode($township_code)
    {
        ...
        if (!is_null($township_code) && (mb_strlen($township_code) > 8)) {
            throw new \InvalidArgumentException('invalid length for $township_code when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 8.');
        }
    ...
    public function setTownshipName($township_name)
    {
        ...
        if (!is_null($township_name) && (mb_strlen($township_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $township_name when calling APIBUSINESSPARTNERABusinessPartnerAddressTypeUpdate., must be smaller than or equal to 40.');
        }
