...
/**
 * APIBUSINESSPARTNERACustUnldgPtAddrDepdntInfoTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustUnldgPtAddrDepdntInfoTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustUnldgPtAddrDepdntInfoType-create';
    ...
    */
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIBUSINESSPARTNERACustUnldgPtAddrDepdntInfoTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if ((mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APIBUSINESSPARTNERACustUnldgPtAddrDepdntInfoTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setUnloadingPointName($unloading_point_name)
    {
        ...
        if ((mb_strlen($unloading_point_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $unloading_point_name when calling APIBUSINESSPARTNERACustUnldgPtAddrDepdntInfoTypeCreate., must be smaller than or equal to 25.');
        }
    ...
    public function setCustomerFactoryCalenderCode($customer_factory_calender_code)
    {
        ...
        if (!is_null($customer_factory_calender_code) && (mb_strlen($customer_factory_calender_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_factory_calender_code when calling APIBUSINESSPARTNERACustUnldgPtAddrDepdntInfoTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setBpGoodsReceivingHoursCode($bp_goods_receiving_hours_code)
    {
        ...
        if (!is_null($bp_goods_receiving_hours_code) && (mb_strlen($bp_goods_receiving_hours_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $bp_goods_receiving_hours_code when calling APIBUSINESSPARTNERACustUnldgPtAddrDepdntInfoTypeCreate., must be smaller than or equal to 3.');
        }
