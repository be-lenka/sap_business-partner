...
/**
 * APIBUSINESSPARTNERABusinessPartnerTaxNumberTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerTaxNumberTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerTaxNumberType-update';
    ...
    */
    ...
    public function setBpTaxNumber($bp_tax_number)
    {
        ...
        if (!is_null($bp_tax_number) && (mb_strlen($bp_tax_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $bp_tax_number when calling APIBUSINESSPARTNERABusinessPartnerTaxNumberTypeUpdate., must be smaller than or equal to 20.');
        }
    ...
    public function setBpTaxLongNumber($bp_tax_long_number)
    {
        ...
        if (!is_null($bp_tax_long_number) && (mb_strlen($bp_tax_long_number) > 60)) {
            throw new \InvalidArgumentException('invalid length for $bp_tax_long_number when calling APIBUSINESSPARTNERABusinessPartnerTaxNumberTypeUpdate., must be smaller than or equal to 60.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERABusinessPartnerTaxNumberTypeUpdate., must be smaller than or equal to 4.');
        }
