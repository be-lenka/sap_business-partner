...
/**
 * APIBUSINESSPARTNERABusinessPartnerRoleTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerRoleTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerRoleType-create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['business_partner_role'] === null) {
            $invalidProperties[] = "'business_partner_role' can't be null";
        }
        if ((mb_strlen($this->container['business_partner_role']) > 6)) {
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABusinessPartnerRoleTypeCreate., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string $business_partner_role business_partner_role
     *
     * @return self
     */
    public function setBusinessPartnerRole($business_partner_role)
    {
        ...
        if ((mb_strlen($business_partner_role) > 6)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_role when calling APIBUSINESSPARTNERABusinessPartnerRoleTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERABusinessPartnerRoleTypeCreate., must be smaller than or equal to 4.');
        }
