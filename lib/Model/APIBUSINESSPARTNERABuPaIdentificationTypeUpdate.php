...
/**
 * APIBUSINESSPARTNERABuPaIdentificationTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABuPaIdentificationTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BuPaIdentificationType-update';
    ...
    */
    ...
    public function setBpIdnNmbrIssuingInstitute($bp_idn_nmbr_issuing_institute)
    {
        ...
        if (!is_null($bp_idn_nmbr_issuing_institute) && (mb_strlen($bp_idn_nmbr_issuing_institute) > 40)) {
            throw new \InvalidArgumentException('invalid length for $bp_idn_nmbr_issuing_institute when calling APIBUSINESSPARTNERABuPaIdentificationTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling APIBUSINESSPARTNERABuPaIdentificationTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $region when calling APIBUSINESSPARTNERABuPaIdentificationTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERABuPaIdentificationTypeUpdate., must be smaller than or equal to 4.');
        }
