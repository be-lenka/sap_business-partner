...
/**
 * APIBUSINESSPARTNERASupplierDunningTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERASupplierDunningTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_SupplierDunningType-create';
    ...
    */
    ...
    public function setSupplier($supplier)
    {
        ...
        if ((mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APIBUSINESSPARTNERASupplierDunningTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setCompanyCode($company_code)
    {
        ...
        if ((mb_strlen($company_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling APIBUSINESSPARTNERASupplierDunningTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setDunningArea($dunning_area)
    {
        ...
        if ((mb_strlen($dunning_area) > 2)) {
            throw new \InvalidArgumentException('invalid length for $dunning_area when calling APIBUSINESSPARTNERASupplierDunningTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setDunningBlock($dunning_block)
    {
        ...
        if (!is_null($dunning_block) && (mb_strlen($dunning_block) > 1)) {
            throw new \InvalidArgumentException('invalid length for $dunning_block when calling APIBUSINESSPARTNERASupplierDunningTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setDunningLevel($dunning_level)
    {
        ...
        if (!is_null($dunning_level) && (mb_strlen($dunning_level) > 1)) {
            throw new \InvalidArgumentException('invalid length for $dunning_level when calling APIBUSINESSPARTNERASupplierDunningTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setDunningProcedure($dunning_procedure)
    {
        ...
        if (!is_null($dunning_procedure) && (mb_strlen($dunning_procedure) > 4)) {
            throw new \InvalidArgumentException('invalid length for $dunning_procedure when calling APIBUSINESSPARTNERASupplierDunningTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setDunningRecipient($dunning_recipient)
    {
        ...
        if (!is_null($dunning_recipient) && (mb_strlen($dunning_recipient) > 10)) {
            throw new \InvalidArgumentException('invalid length for $dunning_recipient when calling APIBUSINESSPARTNERASupplierDunningTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setDunningClerk($dunning_clerk)
    {
        ...
        if (!is_null($dunning_clerk) && (mb_strlen($dunning_clerk) > 2)) {
            throw new \InvalidArgumentException('invalid length for $dunning_clerk when calling APIBUSINESSPARTNERASupplierDunningTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERASupplierDunningTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setSupplierAccountGroup($supplier_account_group)
    {
        ...
        if (!is_null($supplier_account_group) && (mb_strlen($supplier_account_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $supplier_account_group when calling APIBUSINESSPARTNERASupplierDunningTypeCreate., must be smaller than or equal to 4.');
        }
