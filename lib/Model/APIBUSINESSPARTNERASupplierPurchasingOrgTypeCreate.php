...
/**
 * APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_SupplierPurchasingOrgType-create';
    ...
    protected static $openAPITypes = [
        ...
        'to_partner_function' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreateToPartnerFunction',
        'to_purchasing_org_text' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreateToPurchasingOrgText'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['purchasing_organization'] === null) {
            $invalidProperties[] = "'purchasing_organization' can't be null";
        }
        if ((mb_strlen($this->container['purchasing_organization']) > 4)) {
     ...
     * Sets supplier
     *
     * @param string $supplier Supplier's Account Number
     *
     * @return self
     */
    public function setSupplier($supplier)
    {
        ...
        if ((mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string $purchasing_organization Purchasing Organization
     *
     * @return self
     */
    public function setPurchasingOrganization($purchasing_organization)
    {
        ...
        if ((mb_strlen($purchasing_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_organization when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setCalculationSchemaGroupCode($calculation_schema_group_code)
    {
        ...
        if (!is_null($calculation_schema_group_code) && (mb_strlen($calculation_schema_group_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $calculation_schema_group_code when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsVersion($incoterms_version)
    {
        ...
        if (!is_null($incoterms_version) && (mb_strlen($incoterms_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_version when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 70.');
        }
    ...
    public function setIntrastatCrsBorderTrMode($intrastat_crs_border_tr_mode)
    {
        ...
        if (!is_null($intrastat_crs_border_tr_mode) && (mb_strlen($intrastat_crs_border_tr_mode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $intrastat_crs_border_tr_mode when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setPaymentTerms($payment_terms)
    {
        ...
        if (!is_null($payment_terms) && (mb_strlen($payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_terms when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setPlanningCycle($planning_cycle)
    {
        ...
        if (!is_null($planning_cycle) && (mb_strlen($planning_cycle) > 3)) {
            throw new \InvalidArgumentException('invalid length for $planning_cycle when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setPricingDateControl($pricing_date_control)
    {
        ...
        if (!is_null($pricing_date_control) && (mb_strlen($pricing_date_control) > 1)) {
            throw new \InvalidArgumentException('invalid length for $pricing_date_control when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setProdStockAndSlsDataTransfPrfl($prod_stock_and_sls_data_transf_prfl)
    {
        ...
        if (!is_null($prod_stock_and_sls_data_transf_prfl) && (mb_strlen($prod_stock_and_sls_data_transf_prfl) > 4)) {
            throw new \InvalidArgumentException('invalid length for $prod_stock_and_sls_data_transf_prfl when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setProductUnitGroup($product_unit_group)
    {
        ...
        if (!is_null($product_unit_group) && (mb_strlen($product_unit_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $product_unit_group when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setPurchaseOrderCurrency($purchase_order_currency)
    {
        ...
        if (!is_null($purchase_order_currency) && (mb_strlen($purchase_order_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_currency when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setPurchasingGroup($purchasing_group)
    {
        ...
        if (!is_null($purchasing_group) && (mb_strlen($purchasing_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_group when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setRoundingProfile($rounding_profile)
    {
        ...
        if (!is_null($rounding_profile) && (mb_strlen($rounding_profile) > 4)) {
            throw new \InvalidArgumentException('invalid length for $rounding_profile when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingCondition($shipping_condition)
    {
        ...
        if (!is_null($shipping_condition) && (mb_strlen($shipping_condition) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_condition when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setSupplierAbcClassificationCode($supplier_abc_classification_code)
    {
        ...
        if (!is_null($supplier_abc_classification_code) && (mb_strlen($supplier_abc_classification_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $supplier_abc_classification_code when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setSupplierAccountNumber($supplier_account_number)
    {
        ...
        if (!is_null($supplier_account_number) && (mb_strlen($supplier_account_number) > 12)) {
            throw new \InvalidArgumentException('invalid length for $supplier_account_number when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 12.');
        }
    ...
    public function setSupplierPhoneNumber($supplier_phone_number)
    {
        ...
        if (!is_null($supplier_phone_number) && (mb_strlen($supplier_phone_number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $supplier_phone_number when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 16.');
        }
    ...
    public function setSupplierRespSalesPersonName($supplier_resp_sales_person_name)
    {
        ...
        if (!is_null($supplier_resp_sales_person_name) && (mb_strlen($supplier_resp_sales_person_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $supplier_resp_sales_person_name when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 30.');
        }
    ...
    public function setSupplierConfirmationControlKey($supplier_confirmation_control_key)
    {
        ...
        if (!is_null($supplier_confirmation_control_key) && (mb_strlen($supplier_confirmation_control_key) > 4)) {
            throw new \InvalidArgumentException('invalid length for $supplier_confirmation_control_key when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setSupplierAccountGroup($supplier_account_group)
    {
        ...
        if (!is_null($supplier_account_group) && (mb_strlen($supplier_account_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $supplier_account_group when calling APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreate., must be smaller than or equal to 4.');
        }
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreateToPartnerFunction|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreateToPartnerFunction|null $to_partner_function to_partner_function
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreateToPurchasingOrgText|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierPurchasingOrgTypeCreateToPurchasingOrgText|null $to_purchasing_org_text to_purchasing_org_text
     *
     * @return self
     */
