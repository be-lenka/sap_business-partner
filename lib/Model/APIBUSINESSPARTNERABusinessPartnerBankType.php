...
/**
 * APIBUSINESSPARTNERABusinessPartnerBankType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerBankType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerBankType';
    ...
    protected static $setters = [
        ...
        'bank_identification' => 'setBankIdentification',
    ...
    protected static $getters = [
        ...
        'bank_identification' => 'getBankIdentification',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bank_identification', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['bank_identification']) && (mb_strlen($this->container['bank_identification']) > 4)) {
            $invalidProperties[] = "invalid value for 'bank_identification', the character length must be smaller than or equal to 4.";
        }
        ...
        if (!is_null($this->container['bank_name']) && (mb_strlen($this->container['bank_name']) > 60)) {
            $invalidProperties[] = "invalid value for 'bank_name', the character length must be smaller than or equal to 60.";
        }
        ...
        if (!is_null($this->container['city_name']) && (mb_strlen($this->container['city_name']) > 35)) {
            $invalidProperties[] = "invalid value for 'city_name', the character length must be smaller than or equal to 35.";
        }
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 10.');
        }
    ...
    /**
     * Gets bank_identification
     *
     * @return string|null
     */
    public function getBankIdentification()
    {
        return $this->container['bank_identification'];
    }

    /**
     * Sets bank_identification
     *
     * @param string|null $bank_identification bank_identification
     *
     * @return self
     */
    public function setBankIdentification($bank_identification)
    {
        if (is_null($bank_identification)) {
            throw new \InvalidArgumentException('non-nullable bank_identification cannot be null');
        }
        if ((mb_strlen($bank_identification) > 4)) {
            throw new \InvalidArgumentException('invalid length for $bank_identification when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 4.');
        }

        $this->container['bank_identification'] = $bank_identification;
    ...
    public function setBankCountryKey($bank_country_key)
    {
        ...
        if (!is_null($bank_country_key) && (mb_strlen($bank_country_key) > 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_country_key when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 3.');
        }
     ...
     * Sets bank_name
     *
     * @param string|null $bank_name Name of Financial Institution
     *
     * @return self
     */
    public function setBankName($bank_name)
    {
        ...
        if (!is_null($bank_name) && (mb_strlen($bank_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 60.');
        }
    ...
    public function setBankNumber($bank_number)
    {
        ...
        if (!is_null($bank_number) && (mb_strlen($bank_number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $bank_number when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 15.');
        }
     ...
     * Sets swift_code
     *
     * @param string|null $swift_code SWIFT/BIC for International Payments
     *
     * @return self
     */
    public function setSwiftCode($swift_code)
    {
        ...
        if (!is_null($swift_code) && (mb_strlen($swift_code) > 11)) {
            throw new \InvalidArgumentException('invalid length for $swift_code when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 11.');
        }
    ...
    public function setBankControlKey($bank_control_key)
    {
        ...
        if (!is_null($bank_control_key) && (mb_strlen($bank_control_key) > 2)) {
            throw new \InvalidArgumentException('invalid length for $bank_control_key when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 2.');
        }
    ...
    public function setBankAccountHolderName($bank_account_holder_name)
    {
        ...
        if (!is_null($bank_account_holder_name) && (mb_strlen($bank_account_holder_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_holder_name when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 60.');
        }
    ...
    public function setBankAccountName($bank_account_name)
    {
        ...
        if (!is_null($bank_account_name) && (mb_strlen($bank_account_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_name when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 40.');
        }
    ...
    public function setIban($iban)
    {
        ...
        if (!is_null($iban) && (mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 34.');
        }
    ...
    public function setBankAccount($bank_account)
    {
        ...
        if (!is_null($bank_account) && (mb_strlen($bank_account) > 18)) {
            throw new \InvalidArgumentException('invalid length for $bank_account when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 18.');
        }
    ...
    public function setBankAccountReferenceText($bank_account_reference_text)
    {
        ...
        if (!is_null($bank_account_reference_text) && (mb_strlen($bank_account_reference_text) > 20)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_reference_text when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 20.');
        }
    ...
    public function setCityName($city_name)
    {
        ...
        if (!is_null($city_name) && (mb_strlen($city_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $city_name when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 35.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERABusinessPartnerBankType., must be smaller than or equal to 4.');
        }
