...
/**
 * APIBUSINESSPARTNERACustomerWithHoldingTaxTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustomerWithHoldingTaxTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustomerWithHoldingTaxType-update';
    ...
    */
    ...
    public function setWithholdingTaxCode($withholding_tax_code)
    {
        ...
        if (!is_null($withholding_tax_code) && (mb_strlen($withholding_tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_code when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setWithholdingTaxNumber($withholding_tax_number)
    {
        ...
        if (!is_null($withholding_tax_number) && (mb_strlen($withholding_tax_number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_number when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeUpdate., must be smaller than or equal to 16.');
        }
    ...
    public function setWithholdingTaxCertificate($withholding_tax_certificate)
    {
        ...
        if (!is_null($withholding_tax_certificate) && (mb_strlen($withholding_tax_certificate) > 25)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_certificate when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeUpdate., must be smaller than or equal to 25.');
        }
    ...
    public function setExemptionReason($exemption_reason)
    {
        ...
        if (!is_null($exemption_reason) && (mb_strlen($exemption_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $exemption_reason when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERACustomerWithHoldingTaxTypeUpdate., must be smaller than or equal to 4.');
        }
