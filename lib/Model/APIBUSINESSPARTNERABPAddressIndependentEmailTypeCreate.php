...
/**
 * APIBUSINESSPARTNERABPAddressIndependentEmailTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABPAddressIndependentEmailTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BPAddressIndependentEmailType-create';
    ...
    */
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABPAddressIndependentEmailTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if ((mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APIBUSINESSPARTNERABPAddressIndependentEmailTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setPerson($person)
    {
        ...
        if ((mb_strlen($person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $person when calling APIBUSINESSPARTNERABPAddressIndependentEmailTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setOrdinalNumber($ordinal_number)
    {
        ...
        if ((mb_strlen($ordinal_number) > 3)) {
            throw new \InvalidArgumentException('invalid length for $ordinal_number when calling APIBUSINESSPARTNERABPAddressIndependentEmailTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if (!is_null($email_address) && (mb_strlen($email_address) > 241)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling APIBUSINESSPARTNERABPAddressIndependentEmailTypeCreate., must be smaller than or equal to 241.');
        }
