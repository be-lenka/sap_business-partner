...
/**
 * APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BPIntlAddressVersionType-update';
    ...
    */
    ...
    public function setAddressSearchTerm1($address_search_term1)
    {
        ...
        if (!is_null($address_search_term1) && (mb_strlen($address_search_term1) > 20)) {
            throw new \InvalidArgumentException('invalid length for $address_search_term1 when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 20.');
        }
    ...
    public function setAddressSearchTerm2($address_search_term2)
    {
        ...
        if (!is_null($address_search_term2) && (mb_strlen($address_search_term2) > 20)) {
            throw new \InvalidArgumentException('invalid length for $address_search_term2 when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 20.');
        }
    ...
    public function setCareOfName($care_of_name)
    {
        ...
        if (!is_null($care_of_name) && (mb_strlen($care_of_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $care_of_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setCityName($city_name)
    {
        ...
        if (!is_null($city_name) && (mb_strlen($city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setDistrictName($district_name)
    {
        ...
        if (!is_null($district_name) && (mb_strlen($district_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $district_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setFormOfAddress($form_of_address)
    {
        ...
        if (!is_null($form_of_address) && (mb_strlen($form_of_address) > 4)) {
            throw new \InvalidArgumentException('invalid length for $form_of_address when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setHouseNumber($house_number)
    {
        ...
        if (!is_null($house_number) && (mb_strlen($house_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $house_number when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setHouseNumberSupplementText($house_number_supplement_text)
    {
        ...
        if (!is_null($house_number_supplement_text) && (mb_strlen($house_number_supplement_text) > 10)) {
            throw new \InvalidArgumentException('invalid length for $house_number_supplement_text when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setOrganizationName1($organization_name1)
    {
        ...
        if (!is_null($organization_name1) && (mb_strlen($organization_name1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_name1 when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setOrganizationName2($organization_name2)
    {
        ...
        if (!is_null($organization_name2) && (mb_strlen($organization_name2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_name2 when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setOrganizationName3($organization_name3)
    {
        ...
        if (!is_null($organization_name3) && (mb_strlen($organization_name3) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_name3 when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setOrganizationName4($organization_name4)
    {
        ...
        if (!is_null($organization_name4) && (mb_strlen($organization_name4) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_name4 when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setPersonFamilyName($person_family_name)
    {
        ...
        if (!is_null($person_family_name) && (mb_strlen($person_family_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $person_family_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setPersonGivenName($person_given_name)
    {
        ...
        if (!is_null($person_given_name) && (mb_strlen($person_given_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $person_given_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setPoBoxDeviatingCityName($po_box_deviating_city_name)
    {
        ...
        if (!is_null($po_box_deviating_city_name) && (mb_strlen($po_box_deviating_city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $po_box_deviating_city_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setPoBoxLobbyName($po_box_lobby_name)
    {
        ...
        if (!is_null($po_box_lobby_name) && (mb_strlen($po_box_lobby_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $po_box_lobby_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setSecondaryRegionName($secondary_region_name)
    {
        ...
        if (!is_null($secondary_region_name) && (mb_strlen($secondary_region_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $secondary_region_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetName($street_name)
    {
        ...
        if (!is_null($street_name) && (mb_strlen($street_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $street_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 60.');
        }
    ...
    public function setStreetPrefixName1($street_prefix_name1)
    {
        ...
        if (!is_null($street_prefix_name1) && (mb_strlen($street_prefix_name1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_prefix_name1 when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetPrefixName2($street_prefix_name2)
    {
        ...
        if (!is_null($street_prefix_name2) && (mb_strlen($street_prefix_name2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_prefix_name2 when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetSuffixName1($street_suffix_name1)
    {
        ...
        if (!is_null($street_suffix_name1) && (mb_strlen($street_suffix_name1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_suffix_name1 when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetSuffixName2($street_suffix_name2)
    {
        ...
        if (!is_null($street_suffix_name2) && (mb_strlen($street_suffix_name2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_suffix_name2 when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setTertiaryRegionName($tertiary_region_name)
    {
        ...
        if (!is_null($tertiary_region_name) && (mb_strlen($tertiary_region_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $tertiary_region_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setVillageName($village_name)
    {
        ...
        if (!is_null($village_name) && (mb_strlen($village_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $village_name when calling APIBUSINESSPARTNERABPIntlAddressVersionTypeUpdate., must be smaller than or equal to 40.');
        }
