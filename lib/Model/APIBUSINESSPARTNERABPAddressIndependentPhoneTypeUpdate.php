...
/**
 * APIBUSINESSPARTNERABPAddressIndependentPhoneTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABPAddressIndependentPhoneTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BPAddressIndependentPhoneType-update';
    ...
    */
    ...
    public function setDestinationLocationCountry($destination_location_country)
    {
        ...
        if (!is_null($destination_location_country) && (mb_strlen($destination_location_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $destination_location_country when calling APIBUSINESSPARTNERABPAddressIndependentPhoneTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling APIBUSINESSPARTNERABPAddressIndependentPhoneTypeUpdate., must be smaller than or equal to 30.');
        }
    ...
    public function setPhoneNumberExtension($phone_number_extension)
    {
        ...
        if (!is_null($phone_number_extension) && (mb_strlen($phone_number_extension) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_extension when calling APIBUSINESSPARTNERABPAddressIndependentPhoneTypeUpdate., must be smaller than or equal to 10.');
        }
