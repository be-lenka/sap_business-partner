...
/**
 * APIBUSINESSPARTNERABuPaIndustryType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABuPaIndustryType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BuPaIndustryType';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['industry_sector']) && (mb_strlen($this->container['industry_sector']) > 10)) {
            $invalidProperties[] = "invalid value for 'industry_sector', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['industry_system_type']) && (mb_strlen($this->container['industry_system_type']) > 4)) {
    ...
    public function setIndustrySector($industry_sector)
    {
        ...
        if ((mb_strlen($industry_sector) > 10)) {
            throw new \InvalidArgumentException('invalid length for $industry_sector when calling APIBUSINESSPARTNERABuPaIndustryType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string|null $industry_system_type industry_system_type
     *
     * @return self
     */
    public function setIndustrySystemType($industry_system_type)
    {
        ...
        if ((mb_strlen($industry_system_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $industry_system_type when calling APIBUSINESSPARTNERABuPaIndustryType., must be smaller than or equal to 4.');
        }
    ...
    public function setBusinessPartner($business_partner)
    {
        ...
        if ((mb_strlen($business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_partner when calling APIBUSINESSPARTNERABuPaIndustryType., must be smaller than or equal to 10.');
        }
    ...
    public function setIsStandardIndustry($is_standard_industry)
    {
        ...
        if (!is_null($is_standard_industry) && (mb_strlen($is_standard_industry) > 1)) {
            throw new \InvalidArgumentException('invalid length for $is_standard_industry when calling APIBUSINESSPARTNERABuPaIndustryType., must be smaller than or equal to 1.');
        }
    ...
    public function setIndustryKeyDescription($industry_key_description)
    {
        ...
        if (!is_null($industry_key_description) && (mb_strlen($industry_key_description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $industry_key_description when calling APIBUSINESSPARTNERABuPaIndustryType., must be smaller than or equal to 100.');
        }
