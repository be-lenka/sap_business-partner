...
/**
 * APIBUSINESSPARTNERASupplierCompanyType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERASupplierCompanyType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_SupplierCompanyType';
    ...
    protected static $openAPITypes = [
        ...
        'to_company_text' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeToCompanyText',
        'to_supplier' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierType',
        'to_supplier_dunning' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeToSupplierDunning',
        'to_supplier_with_holding_tax' => '\BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeToSupplierWithHoldingTax'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'to_supplier' => null,
        'to_supplier_dunning' => null,
        'to_supplier_with_holding_tax' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'to_supplier' => false,
		'to_supplier_dunning' => false,
		'to_supplier_with_holding_tax' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'to_supplier_dunning' => 'to_SupplierDunning',
        'to_supplier_with_holding_tax' => 'to_SupplierWithHoldingTax'
    ];
    ...
    protected static $setters = [
        ...
        'company_code_name' => 'setCompanyCodeName',
        ...
        'to_supplier_dunning' => 'setToSupplierDunning',
        'to_supplier_with_holding_tax' => 'setToSupplierWithHoldingTax'
    ];
    ...
    protected static $getters = [
        ...
        'company_code_name' => 'getCompanyCodeName',
        ...
        'to_supplier_dunning' => 'getToSupplierDunning',
        'to_supplier_with_holding_tax' => 'getToSupplierWithHoldingTax'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('company_code_name', $data ?? [], null);
        ...
        $this->setIfExists('to_supplier_dunning', $data ?? [], null);
        $this->setIfExists('to_supplier_with_holding_tax', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['company_code_name']) && (mb_strlen($this->container['company_code_name']) > 25)) {
            $invalidProperties[] = "invalid value for 'company_code_name', the character length must be smaller than or equal to 25.";
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if ((mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setCompanyCode($company_code)
    {
        ...
        if ((mb_strlen($company_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 4.');
        }
    ...
    public function setAuthorizationGroup($authorization_group)
    {
        ...
        if (!is_null($authorization_group) && (mb_strlen($authorization_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $authorization_group when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 4.');
        }
    ...
    /**
     * Gets company_code_name
     *
     * @return string|null
     */
    public function getCompanyCodeName()
    {
        return $this->container['company_code_name'];
    }

    /**
     * Sets company_code_name
     *
     * @param string|null $company_code_name Name of Company Code or Company
     *
     * @return self
     */
    public function setCompanyCodeName($company_code_name)
    {
        if (is_null($company_code_name)) {
            array_push($this->openAPINullablesSetToNull, 'company_code_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('company_code_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($company_code_name) && (mb_strlen($company_code_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $company_code_name when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 25.');
        }

        $this->container['company_code_name'] = $company_code_name;
    ...
    public function setPaymentBlockingReason($payment_blocking_reason)
    {
        ...
        if (!is_null($payment_blocking_reason) && (mb_strlen($payment_blocking_reason) > 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_blocking_reason when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 1.');
        }
    ...
    public function setAccountingClerk($accounting_clerk)
    {
        ...
        if (!is_null($accounting_clerk) && (mb_strlen($accounting_clerk) > 2)) {
            throw new \InvalidArgumentException('invalid length for $accounting_clerk when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 2.');
        }
    ...
    public function setAccountingClerkFaxNumber($accounting_clerk_fax_number)
    {
        ...
        if (!is_null($accounting_clerk_fax_number) && (mb_strlen($accounting_clerk_fax_number) > 31)) {
            throw new \InvalidArgumentException('invalid length for $accounting_clerk_fax_number when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 31.');
        }
    ...
    public function setAccountingClerkPhoneNumber($accounting_clerk_phone_number)
    {
        ...
        if (!is_null($accounting_clerk_phone_number) && (mb_strlen($accounting_clerk_phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $accounting_clerk_phone_number when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 30.');
        }
    ...
    public function setSupplierClerk($supplier_clerk)
    {
        ...
        if (!is_null($supplier_clerk) && (mb_strlen($supplier_clerk) > 15)) {
            throw new \InvalidArgumentException('invalid length for $supplier_clerk when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 15.');
        }
    ...
    public function setSupplierClerkUrl($supplier_clerk_url)
    {
        ...
        if (!is_null($supplier_clerk_url) && (mb_strlen($supplier_clerk_url) > 130)) {
            throw new \InvalidArgumentException('invalid length for $supplier_clerk_url when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 130.');
        }
    ...
    public function setPaymentMethodsList($payment_methods_list)
    {
        ...
        if (!is_null($payment_methods_list) && (mb_strlen($payment_methods_list) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_methods_list when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setPaymentReason($payment_reason)
    {
        ...
        if (!is_null($payment_reason) && (mb_strlen($payment_reason) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_reason when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentTerms($payment_terms)
    {
        ...
        if (!is_null($payment_terms) && (mb_strlen($payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_terms when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 4.');
        }
    ...
    public function setHouseBank($house_bank)
    {
        ...
        if (!is_null($house_bank) && (mb_strlen($house_bank) > 5)) {
            throw new \InvalidArgumentException('invalid length for $house_bank when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 5.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 5.');
        }
    ...
    public function setSupplierClerkIdbySupplier($supplier_clerk_idby_supplier)
    {
        ...
        if (!is_null($supplier_clerk_idby_supplier) && (mb_strlen($supplier_clerk_idby_supplier) > 12)) {
            throw new \InvalidArgumentException('invalid length for $supplier_clerk_idby_supplier when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 12.');
        }
    ...
    public function setReconciliationAccount($reconciliation_account)
    {
        ...
        if (!is_null($reconciliation_account) && (mb_strlen($reconciliation_account) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reconciliation_account when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setInterestCalculationCode($interest_calculation_code)
    {
        ...
        if (!is_null($interest_calculation_code) && (mb_strlen($interest_calculation_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $interest_calculation_code when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 2.');
        }
    ...
    public function setIntrstCalcFrequencyInMonths($intrst_calc_frequency_in_months)
    {
        ...
        if (!is_null($intrst_calc_frequency_in_months) && (mb_strlen($intrst_calc_frequency_in_months) > 2)) {
            throw new \InvalidArgumentException('invalid length for $intrst_calc_frequency_in_months when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 2.');
        }
    ...
    public function setSupplierHeadOffice($supplier_head_office)
    {
        ...
        if (!is_null($supplier_head_office) && (mb_strlen($supplier_head_office) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier_head_office when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setAlternativePayee($alternative_payee)
    {
        ...
        if (!is_null($alternative_payee) && (mb_strlen($alternative_payee) > 10)) {
            throw new \InvalidArgumentException('invalid length for $alternative_payee when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setLayoutSortingRule($layout_sorting_rule)
    {
        ...
        if (!is_null($layout_sorting_rule) && (mb_strlen($layout_sorting_rule) > 3)) {
            throw new \InvalidArgumentException('invalid length for $layout_sorting_rule when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 3.');
        }
    ...
    public function setAparToleranceGroup($apar_tolerance_group)
    {
        ...
        if (!is_null($apar_tolerance_group) && (mb_strlen($apar_tolerance_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $apar_tolerance_group when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 4.');
        }
    ...
    public function setSupplierAccountNote($supplier_account_note)
    {
        ...
        if (!is_null($supplier_account_note) && (mb_strlen($supplier_account_note) > 30)) {
            throw new \InvalidArgumentException('invalid length for $supplier_account_note when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 30.');
        }
    ...
    public function setWithholdingTaxCountry($withholding_tax_country)
    {
        ...
        if (!is_null($withholding_tax_country) && (mb_strlen($withholding_tax_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_country when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 3.');
        }
    ...
    public function setCashPlanningGroup($cash_planning_group)
    {
        ...
        if (!is_null($cash_planning_group) && (mb_strlen($cash_planning_group) > 10)) {
            throw new \InvalidArgumentException('invalid length for $cash_planning_group when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 10.');
        }
    ...
    public function setMinorityGroup($minority_group)
    {
        ...
        if (!is_null($minority_group) && (mb_strlen($minority_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $minority_group when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 3.');
        }
    ...
    public function setSupplierAccountGroup($supplier_account_group)
    {
        ...
        if (!is_null($supplier_account_group) && (mb_strlen($supplier_account_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $supplier_account_group when calling APIBUSINESSPARTNERASupplierCompanyType., must be smaller than or equal to 4.');
        }
     ...
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeToCompanyText|null
     */
     ...
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeToCompanyText|null $to_company_text to_company_text
     *
     * @return self
     */
    ...
    public function setToSupplier($to_supplier)
    {
        if (is_null($to_supplier)) {
            throw new \InvalidArgumentException('non-nullable to_supplier cannot be null');
        }
    ...
    /**
     * Gets to_supplier_dunning
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeToSupplierDunning|null
     */
    public function getToSupplierDunning()
    {
        return $this->container['to_supplier_dunning'];
    }

    /**
     * Sets to_supplier_dunning
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeToSupplierDunning|null $to_supplier_dunning to_supplier_dunning
     *
     * @return self
     */
    public function setToSupplierDunning($to_supplier_dunning)
    {
        if (is_null($to_supplier_dunning)) {
            throw new \InvalidArgumentException('non-nullable to_supplier_dunning cannot be null');
        }
        $this->container['to_supplier_dunning'] = $to_supplier_dunning;

        return $this;
    }

    /**
     * Gets to_supplier_with_holding_tax
     *
     * @return \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeToSupplierWithHoldingTax|null
     */
    public function getToSupplierWithHoldingTax()
    {
        return $this->container['to_supplier_with_holding_tax'];
    }

    /**
     * Sets to_supplier_with_holding_tax
     *
     * @param \BeLenka\SAP\BusinessPartner\Model\APIBUSINESSPARTNERASupplierCompanyTypeToSupplierWithHoldingTax|null $to_supplier_with_holding_tax to_supplier_with_holding_tax
     *
     * @return self
     */
    public function setToSupplierWithHoldingTax($to_supplier_with_holding_tax)
    {
        if (is_null($to_supplier_with_holding_tax)) {
            throw new \InvalidArgumentException('non-nullable to_supplier_with_holding_tax cannot be null');
        }
        $this->container['to_supplier_with_holding_tax'] = $to_supplier_with_holding_tax;
