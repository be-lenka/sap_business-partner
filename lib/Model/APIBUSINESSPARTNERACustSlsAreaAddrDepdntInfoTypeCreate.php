...
/**
 * APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_CustSlsAreaAddrDepdntInfoType-create';
    ...
    */
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrganization($sales_organization)
    {
        ...
        if ((mb_strlen($sales_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_organization when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setDistributionChannel($distribution_channel)
    {
        ...
        if ((mb_strlen($distribution_channel) > 2)) {
            throw new \InvalidArgumentException('invalid length for $distribution_channel when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setDivision($division)
    {
        ...
        if ((mb_strlen($division) > 2)) {
            throw new \InvalidArgumentException('invalid length for $division when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if ((mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 70.');
        }
    ...
    public function setDeliveryIsBlocked($delivery_is_blocked)
    {
        ...
        if (!is_null($delivery_is_blocked) && (mb_strlen($delivery_is_blocked) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_is_blocked when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setSalesOffice($sales_office)
    {
        ...
        if (!is_null($sales_office) && (mb_strlen($sales_office) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_office when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesGroup($sales_group)
    {
        ...
        if (!is_null($sales_group) && (mb_strlen($sales_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sales_group when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setShippingCondition($shipping_condition)
    {
        ...
        if (!is_null($shipping_condition) && (mb_strlen($shipping_condition) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_condition when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setSupplyingPlant($supplying_plant)
    {
        ...
        if (!is_null($supplying_plant) && (mb_strlen($supplying_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $supplying_plant when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setIncotermsVersion($incoterms_version)
    {
        ...
        if (!is_null($incoterms_version) && (mb_strlen($incoterms_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_version when calling APIBUSINESSPARTNERACustSlsAreaAddrDepdntInfoTypeCreate., must be smaller than or equal to 4.');
        }
