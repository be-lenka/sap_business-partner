...
/**
 * APIBUSINESSPARTNERABPAddrDepdntIntlLocNumberTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABPAddrDepdntIntlLocNumberTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BPAddrDepdntIntlLocNumberType-update';
    ...
    */
    ...
    public function setInternationalLocationNumber1($international_location_number1)
    {
        ...
        if (!is_null($international_location_number1) && (mb_strlen($international_location_number1) > 7)) {
            throw new \InvalidArgumentException('invalid length for $international_location_number1 when calling APIBUSINESSPARTNERABPAddrDepdntIntlLocNumberTypeUpdate., must be smaller than or equal to 7.');
        }
    ...
    public function setInternationalLocationNumber2($international_location_number2)
    {
        ...
        if (!is_null($international_location_number2) && (mb_strlen($international_location_number2) > 5)) {
            throw new \InvalidArgumentException('invalid length for $international_location_number2 when calling APIBUSINESSPARTNERABPAddrDepdntIntlLocNumberTypeUpdate., must be smaller than or equal to 5.');
        }
    ...
    public function setInternationalLocationNumber3($international_location_number3)
    {
        ...
        if (!is_null($international_location_number3) && (mb_strlen($international_location_number3) > 1)) {
            throw new \InvalidArgumentException('invalid length for $international_location_number3 when calling APIBUSINESSPARTNERABPAddrDepdntIntlLocNumberTypeUpdate., must be smaller than or equal to 1.');
        }
