...
/**
 * APIBUSINESSPARTNERAAddressEmailAddressTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERAAddressEmailAddressTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_AddressEmailAddressType-update';
    ...
    */
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if (!is_null($email_address) && (mb_strlen($email_address) > 241)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling APIBUSINESSPARTNERAAddressEmailAddressTypeUpdate., must be smaller than or equal to 241.');
        }
    ...
    public function setAddressCommunicationRemarkText($address_communication_remark_text)
    {
        ...
        if (!is_null($address_communication_remark_text) && (mb_strlen($address_communication_remark_text) > 50)) {
            throw new \InvalidArgumentException('invalid length for $address_communication_remark_text when calling APIBUSINESSPARTNERAAddressEmailAddressTypeUpdate., must be smaller than or equal to 50.');
        }
