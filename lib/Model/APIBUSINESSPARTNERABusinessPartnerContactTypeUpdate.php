...
/**
 * APIBUSINESSPARTNERABusinessPartnerContactTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BusinessPartner
 * @author   OpenAPI Generator team
 ...
 */
class APIBUSINESSPARTNERABusinessPartnerContactTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BUSINESS_PARTNER.A_BusinessPartnerContactType-update';
    ...
    */
    ...
    public function setRelationshipCategory($relationship_category)
    {
        ...
        if (!is_null($relationship_category) && (mb_strlen($relationship_category) > 6)) {
            throw new \InvalidArgumentException('invalid length for $relationship_category when calling APIBUSINESSPARTNERABusinessPartnerContactTypeUpdate., must be smaller than or equal to 6.');
        }
