# BeLenka\SAP\BusinessPartner\CustomerApi

All URIs are relative to https://:/sap/opu/odata/sap/API_BUSINESS_PARTNER, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**aBusinessPartnerBusinessPartnerToCustomerGet()**](CustomerApi.md#aBusinessPartnerBusinessPartnerToCustomerGet) | **GET** /A_BusinessPartner(&#39;{BusinessPartner}&#39;)/to_Customer | Retrieves customer general data. |
| [**aCustomerCustomerGet()**](CustomerApi.md#aCustomerCustomerGet) | **GET** /A_Customer(&#39;{Customer}&#39;) | Retrieves customer data by using customer number. |
| [**aCustomerCustomerPatch()**](CustomerApi.md#aCustomerCustomerPatch) | **PATCH** /A_Customer(&#39;{Customer}&#39;) | Updates customer general data. |
| [**aCustomerCustomerToCustAddrDepdntExtIdentifierGet()**](CustomerApi.md#aCustomerCustomerToCustAddrDepdntExtIdentifierGet) | **GET** /A_Customer(&#39;{Customer}&#39;)/to_CustAddrDepdntExtIdentifier | Get entities from related to_CustAddrDepdntExtIdentifier |
| [**aCustomerCustomerToCustAddrDepdntExtIdentifierPost()**](CustomerApi.md#aCustomerCustomerToCustAddrDepdntExtIdentifierPost) | **POST** /A_Customer(&#39;{Customer}&#39;)/to_CustAddrDepdntExtIdentifier | Add new entity to related to_CustAddrDepdntExtIdentifier |
| [**aCustomerCustomerToCustAddrDepdntInformationGet()**](CustomerApi.md#aCustomerCustomerToCustAddrDepdntInformationGet) | **GET** /A_Customer(&#39;{Customer}&#39;)/to_CustAddrDepdntInformation | Retrieves address dependent customer data. |
| [**aCustomerCustomerToCustAddrDepdntInformationPost()**](CustomerApi.md#aCustomerCustomerToCustAddrDepdntInformationPost) | **POST** /A_Customer(&#39;{Customer}&#39;)/to_CustAddrDepdntInformation | Creates new address dependent customer data. |
| [**aCustomerCustomerToCustUnldgPtAddrDepdntInfoGet()**](CustomerApi.md#aCustomerCustomerToCustUnldgPtAddrDepdntInfoGet) | **GET** /A_Customer(&#39;{Customer}&#39;)/to_CustUnldgPtAddrDepdntInfo | Retrieves address dependent customer unloading point data. |
| [**aCustomerCustomerToCustUnldgPtAddrDepdntInfoPost()**](CustomerApi.md#aCustomerCustomerToCustUnldgPtAddrDepdntInfoPost) | **POST** /A_Customer(&#39;{Customer}&#39;)/to_CustUnldgPtAddrDepdntInfo | Creates new address dependent customer unloading point data. |
| [**aCustomerCustomerToCustomerCompanyGet()**](CustomerApi.md#aCustomerCustomerToCustomerCompanyGet) | **GET** /A_Customer(&#39;{Customer}&#39;)/to_CustomerCompany | Retrieves customer company data. |
| [**aCustomerCustomerToCustomerCompanyPost()**](CustomerApi.md#aCustomerCustomerToCustomerCompanyPost) | **POST** /A_Customer(&#39;{Customer}&#39;)/to_CustomerCompany | Creates new company code data linked to the customer. |
| [**aCustomerCustomerToCustomerSalesAreaGet()**](CustomerApi.md#aCustomerCustomerToCustomerSalesAreaGet) | **GET** /A_Customer(&#39;{Customer}&#39;)/to_CustomerSalesArea | Retrieves customer sales area data. |
| [**aCustomerCustomerToCustomerSalesAreaPost()**](CustomerApi.md#aCustomerCustomerToCustomerSalesAreaPost) | **POST** /A_Customer(&#39;{Customer}&#39;)/to_CustomerSalesArea | Creates customer sales data. |
| [**aCustomerCustomerToCustomerTaxGroupingGet()**](CustomerApi.md#aCustomerCustomerToCustomerTaxGroupingGet) | **GET** /A_Customer(&#39;{Customer}&#39;)/to_CustomerTaxGrouping | Retrieves customer tax grouping data. |
| [**aCustomerCustomerToCustomerTextGet()**](CustomerApi.md#aCustomerCustomerToCustomerTextGet) | **GET** /A_Customer(&#39;{Customer}&#39;)/to_CustomerText | Retrieves customer text data. |
| [**aCustomerCustomerToCustomerTextPost()**](CustomerApi.md#aCustomerCustomerToCustomerTextPost) | **POST** /A_Customer(&#39;{Customer}&#39;)/to_CustomerText | Creates customer long text. |
| [**aCustomerCustomerToCustomerUnloadingPointGet()**](CustomerApi.md#aCustomerCustomerToCustomerUnloadingPointGet) | **GET** /A_Customer(&#39;{Customer}&#39;)/to_CustomerUnloadingPoint | Retrieves customer unloading point data. |
| [**aCustomerCustomerToCustomerUnloadingPointPost()**](CustomerApi.md#aCustomerCustomerToCustomerUnloadingPointPost) | **POST** /A_Customer(&#39;{Customer}&#39;)/to_CustomerUnloadingPoint | Creates new customer unloading point record. |
| [**aCustomerGet()**](CustomerApi.md#aCustomerGet) | **GET** /A_Customer | Retrieves customer general data. |


## `aBusinessPartnerBusinessPartnerToCustomerGet()`

```php
aBusinessPartnerBusinessPartnerToCustomerGet($business_partner, $select, $expand): \BeLenka\SAP\BusinessPartner\Model\ACustomerType
```
...
$apiInstance = new BeLenka\SAP\BusinessPartner\Api\CustomerApi(
...
try {
    $result = $apiInstance->aBusinessPartnerBusinessPartnerToCustomerGet($business_partner, $select, $expand);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CustomerApi->aBusinessPartnerBusinessPartnerToCustomerGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\BeLenka\SAP\BusinessPartner\Model\ACustomerType**](../Model/ACustomerType.md)
...
```php
aCustomerCustomerGet($customer, $select, $expand): \BeLenka\SAP\BusinessPartner\Model\ACustomerType
```
...
try {
    $result = $apiInstance->aCustomerCustomerGet($customer, $select, $expand);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CustomerApi->aCustomerCustomerGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
aCustomerCustomerPatch($customer, $modified_a_customer_type)
```
...
$customer = 'customer_example'; // string | Customer Number
$modified_a_customer_type = new \BeLenka\SAP\BusinessPartner\Model\ModifiedACustomerType(); // \BeLenka\SAP\BusinessPartner\Model\ModifiedACustomerType | New property values

try {
    $apiInstance->aCustomerCustomerPatch($customer, $modified_a_customer_type);
} catch (Exception $e) {
    echo 'Exception when calling CustomerApi->aCustomerCustomerPatch: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **customer** | **string**| Customer Number | |
| **modified_a_customer_type** | [**\BeLenka\SAP\BusinessPartner\Model\ModifiedACustomerType**](../Model/ModifiedACustomerType.md)| New property values | |
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustAddrDepdntExtIdentifierGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustAddrDepdntExtIdentifierPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustAddrDepdntInformationGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustAddrDepdntInformationPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustUnldgPtAddrDepdntInfoGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustUnldgPtAddrDepdntInfoPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustomerCompanyGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustomerCompanyPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustomerSalesAreaGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustomerSalesAreaPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustomerTaxGroupingGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustomerTextGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustomerTextPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustomerUnloadingPointGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerApi->aCustomerCustomerToCustomerUnloadingPointPost: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
aCustomerGet($top, $skip, $filter, $inlinecount, $orderby, $select, $expand): \BeLenka\SAP\BusinessPartner\Model\Wrapper36
```
...
try {
    $result = $apiInstance->aCustomerGet($top, $skip, $filter, $inlinecount, $orderby, $select, $expand);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CustomerApi->aCustomerGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\BeLenka\SAP\BusinessPartner\Model\Wrapper36**](../Model/Wrapper36.md)
