# BeLenka\SAP\BusinessPartner\SupplierApi

All URIs are relative to https://:/sap/opu/odata/sap/API_BUSINESS_PARTNER, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**aBusinessPartnerBusinessPartnerToSupplierGet()**](SupplierApi.md#aBusinessPartnerBusinessPartnerToSupplierGet) | **GET** /A_BusinessPartner(&#39;{BusinessPartner}&#39;)/to_Supplier | Retrieves supplier general data. |
| [**aSupplierCompanySupplierSupplierCompanyCodeCompanyCodeToSupplierGet()**](SupplierApi.md#aSupplierCompanySupplierSupplierCompanyCodeCompanyCodeToSupplierGet) | **GET** /A_SupplierCompany(Supplier&#x3D;&#39;{Supplier}&#39;,CompanyCode&#x3D;&#39;{CompanyCode}&#39;)/to_Supplier | Retrieves supplier general data. |
| [**aSupplierGet()**](SupplierApi.md#aSupplierGet) | **GET** /A_Supplier | Retrieves supplier general data. |
| [**aSupplierSupplierGet()**](SupplierApi.md#aSupplierSupplierGet) | **GET** /A_Supplier(&#39;{Supplier}&#39;) | Retrieves supplier general data by using supplier number. |
| [**aSupplierSupplierPatch()**](SupplierApi.md#aSupplierSupplierPatch) | **PATCH** /A_Supplier(&#39;{Supplier}&#39;) | Updates supplier general data. |
| [**aSupplierSupplierToSupplierCompanyGet()**](SupplierApi.md#aSupplierSupplierToSupplierCompanyGet) | **GET** /A_Supplier(&#39;{Supplier}&#39;)/to_SupplierCompany | Retrieves supplier company data. |
| [**aSupplierSupplierToSupplierCompanyPost()**](SupplierApi.md#aSupplierSupplierToSupplierCompanyPost) | **POST** /A_Supplier(&#39;{Supplier}&#39;)/to_SupplierCompany | Creates supplier company data. |
| [**aSupplierSupplierToSupplierPurchasingOrgGet()**](SupplierApi.md#aSupplierSupplierToSupplierPurchasingOrgGet) | **GET** /A_Supplier(&#39;{Supplier}&#39;)/to_SupplierPurchasingOrg | Retrieves supplier purchasing organization data. |
| [**aSupplierSupplierToSupplierPurchasingOrgPost()**](SupplierApi.md#aSupplierSupplierToSupplierPurchasingOrgPost) | **POST** /A_Supplier(&#39;{Supplier}&#39;)/to_SupplierPurchasingOrg | Creates supplier purchasing organization data. |
| [**aSupplierSupplierToSupplierTextGet()**](SupplierApi.md#aSupplierSupplierToSupplierTextGet) | **GET** /A_Supplier(&#39;{Supplier}&#39;)/to_SupplierText | Retrieves supplier text data. |
| [**aSupplierSupplierToSupplierTextPost()**](SupplierApi.md#aSupplierSupplierToSupplierTextPost) | **POST** /A_Supplier(&#39;{Supplier}&#39;)/to_SupplierText | Creates supplier text data. |


## `aBusinessPartnerBusinessPartnerToSupplierGet()`

```php
aBusinessPartnerBusinessPartnerToSupplierGet($business_partner, $select, $expand): \BeLenka\SAP\BusinessPartner\Model\ASupplierType
```
...
$apiInstance = new BeLenka\SAP\BusinessPartner\Api\SupplierApi(
...
try {
    $result = $apiInstance->aBusinessPartnerBusinessPartnerToSupplierGet($business_partner, $select, $expand);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SupplierApi->aBusinessPartnerBusinessPartnerToSupplierGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SupplierApi->aSupplierCompanySupplierSupplierCompanyCodeCompanyCodeToSupplierGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
aSupplierGet($top, $skip, $filter, $inlinecount, $orderby, $select, $expand): \BeLenka\SAP\BusinessPartner\Model\Wrapper51
```
...
try {
    $result = $apiInstance->aSupplierGet($top, $skip, $filter, $inlinecount, $orderby, $select, $expand);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SupplierApi->aSupplierGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\BeLenka\SAP\BusinessPartner\Model\Wrapper51**](../Model/Wrapper51.md)
...
```php
aSupplierSupplierGet($supplier, $select, $expand): \BeLenka\SAP\BusinessPartner\Model\ASupplierType
```
...
try {
    $result = $apiInstance->aSupplierSupplierGet($supplier, $select, $expand);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SupplierApi->aSupplierSupplierGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
aSupplierSupplierPatch($supplier, $modified_a_supplier_type)
```
...
$supplier = 'supplier_example'; // string | Account Number of Supplier
$modified_a_supplier_type = new \BeLenka\SAP\BusinessPartner\Model\ModifiedASupplierType(); // \BeLenka\SAP\BusinessPartner\Model\ModifiedASupplierType | New property values

try {
    $apiInstance->aSupplierSupplierPatch($supplier, $modified_a_supplier_type);
} catch (Exception $e) {
    echo 'Exception when calling SupplierApi->aSupplierSupplierPatch: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **supplier** | **string**| Account Number of Supplier | |
| **modified_a_supplier_type** | [**\BeLenka\SAP\BusinessPartner\Model\ModifiedASupplierType**](../Model/ModifiedASupplierType.md)| New property values | |
...
try {
    ...
    echo 'Exception when calling SupplierApi->aSupplierSupplierToSupplierCompanyGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SupplierApi->aSupplierSupplierToSupplierCompanyPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SupplierApi->aSupplierSupplierToSupplierPurchasingOrgGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SupplierApi->aSupplierSupplierToSupplierPurchasingOrgPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SupplierApi->aSupplierSupplierToSupplierTextGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SupplierApi->aSupplierSupplierToSupplierTextPost: ', $e->getMessage(), PHP_EOL;
}
```
